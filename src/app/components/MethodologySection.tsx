      ...
      <div className="container-default">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {t.methodology.cards.map((card: any, index: number) => {
            ...
            return (
              <div key={index} className="group relative bg-[#15171e] p-8 rounded-2xl border border-white/5 hover:border-brand-primary/30 transition-all hover:-translate-y-1 duration-300 z-10">
                ...
                <div className="relative w-12 h-12 bg-[#15171e] rounded-lg flex items-center justify-center mb-6 text-brand-primary border border-white/5 shadow-inner group-hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all">
                  <div className="absolute inset-0 bg-brand-primary/10 rounded-lg blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
