    ...
    <section className="section-spacing bg-brand-background-secondary border-t border-brand-border" id="case-studies">
      <div className="container-default">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          ...
          <a
            href="#resources"
            className="text-sm font-bold uppercase tracking-widest text-brand-text-muted hover:text-brand-accent transition-colors"
          >
            Zobrazit všechny →
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {caseStudies.map((item) => (
            ...
            >
              ...
              <div className="flex items-center text-sm font-bold text-brand-accent group-hover:text-brand-accent-hover">
