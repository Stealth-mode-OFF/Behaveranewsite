...
const bios: Record<string, Record<string, string>> = {
  cz: {
    'Jiří Valena': '15 let v B2B a řízení obchodních týmů.',
    'Igor Kubíček': 'Produktový designér se zaměřením na behaviorální data.',
    'Dušan Švancara': 'Full-stack architekt. Infrastruktura a bezpečnost.',
    'Jana Šrámková': 'Marketing a partnerships v B2B SaaS.',
    'Veronika Nováková': 'Onboarding, retence a péče o zákazníky.',
    'Josef Hofman': 'Obchod a rozvoj klientského portfolia.',
  },
  en: {
    'Jiří Valena': '15 years in B2B and sales team leadership.',
    'Igor Kubíček': 'Product designer focused on behavioral data.',
    'Dušan Švancara': 'Full-stack architect. Infrastructure & security.',
    'Jana Šrámková': 'Marketing and partnerships in B2B SaaS.',
    'Veronika Nováková': 'Onboarding, retention, and customer care.',
    'Josef Hofman': 'Sales and client portfolio development.',
  },
  de: {
    'Jiří Valena': '15 Jahre B2B und Vertriebsführung.',
    'Igor Kubíček': 'Produktdesigner mit Fokus auf Verhaltensdaten.',
    'Dušan Švancara': 'Full-Stack-Architekt. Infrastruktur & Sicherheit.',
    'Jana Šrámková': 'Marketing und Partnerschaften im B2B-SaaS.',
    'Veronika Nováková': 'Onboarding, Kundenbindung und Betreuung.',
    'Josef Hofman': 'Vertrieb und Kundenportfolio-Entwicklung.',
  },
};
