  ...
  return (
    <section className="py-20 md:py-28 lg:py-32 bg-white relative overflow-hidden" id="preview">
      ...
      <div className="container-default max-w-[1120px] mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-20 max-w-full">
            <motion.div 
        ...
        <motion.div 
             ...
             className="relative rounded-2xl overflow-hidden shadow-2xl border border-brand-border/40 bg-brand-background-secondary mb-16 md:mb-24 max-w-full ring-1 ring-brand-primary/5 group cursor-pointer"
             onClick={openVideo}
             role="button"
             tabIndex={0}
        ...
        {/* Key Capabilities Grid - Calm & Technical */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-14 max-w-full border-t border-brand-border pt-12 md:pt-16">
