    ...
    <Dialog open={isBookingOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[960px] p-0 overflow-hidden border-0 max-h-[100dvh] sm:max-h-[92vh] flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row min-h-0 flex-1">
          ...
          <div className="hidden lg:flex lg:w-[320px] shrink-0 flex-col bg-gradient-to-b from-brand-primary via-[#2D1B69] to-[#120B25] text-white p-8 relative overflow-hidden">
            {/* Subtle grid bg */}
