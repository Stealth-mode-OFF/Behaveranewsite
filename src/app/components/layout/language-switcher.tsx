...
export function LanguageSwitcher() {
  ...
  return (
    <Button 
      ...
      title={language === 'cz' ? `Přepnout jazyk (aktuálně: ${currentLanguage.label})` : language === 'de' ? `Sprache wechseln (aktuell: ${currentLanguage.label})` : `Switch language (current: ${currentLanguage.label})`}
      aria-label={language === 'cz' ? `Přepnout jazyk (aktuálně: ${currentLanguage.label})` : language === 'de' ? `Sprache wechseln (aktuell: ${currentLanguage.label})` : `Switch language (current: ${currentLanguage.label})`}
    >
