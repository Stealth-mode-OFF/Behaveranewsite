...
export function DecisionLock() {
  ...
  return (
    <section className="py-24 bg-slate-950 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-brand-primary/5 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="container-default max-w-4xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center justify-center p-3 mb-8 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
                <Lock className="w-5 h-5 text-brand-primary opacity-80" />
            </div>
            ...
            <div className="flex justify-center">
                <Button 
                    onClick={openBooking}
                    className="h-14 px-10 bg-white text-slate-950 hover:bg-slate-200 text-lg font-bold rounded-lg shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all hover:scale-105"
                >
                    {t.decisionLock.cta}
