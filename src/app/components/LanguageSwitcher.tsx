...
export function LanguageSwitcher() {
  ...
  return (
    <Button 
      ...
      className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-brand-background-secondary transition-colors focus-visible:ring-0 focus-visible:ring-offset-0"
