...
export function CzechRealitySection() {
  ...
  return (
    <section className="py-24 bg-brand-primary text-indigo-100 border-t border-white/5">
      <div className="container-default">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white/5 border border-white/5 p-8 rounded-lg flex flex-col h-full hover:border-white/10 transition-colors group">
                ...
                <ul className="space-y-6 text-sm md:text-base leading-relaxed mb-8 flex-1">
                    <li className="flex gap-4">
                        ...
                        <div>
                            ...
                            <span className="text-indigo-200">{t.czechReality.archetypeA.point1.desc}</span>
                        </div>
                    </li>
                    <li className="flex gap-4">
                        <span className="text-orange-500/50 font-mono text-xs pt-1">02</span>
                         <div>
                            ...
                            <span className="text-indigo-200">{t.czechReality.archetypeA.point2.desc}</span>
                        </div>
                    </li>
                </ul>
                ...
                <ul className="space-y-6 text-sm md:text-base leading-relaxed mb-8 flex-1">
                    <li className="flex gap-4">
                        ...
                        <div>
                            ...
                            <span className="text-indigo-200">{t.czechReality.archetypeB.point1.desc}</span>
                        </div>
                    </li>
                    <li className="flex gap-4">
                        ...
                        <div>
                            ...
                            <span className="text-indigo-200">{t.czechReality.archetypeB.point2.desc}</span>
                        </div>
                    </li>
                </ul>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white/5 border border-white/5 rounded-lg p-8 shadow-lg">
