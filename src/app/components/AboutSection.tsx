...
export function AboutSection() {
  ...
  return (
    <section className="section-spacing bg-white border-b border-slate-200" id="about">
          ...
          <div className="grid gap-6">
            {highlights.map((item) => {
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-brand-primary mb-4">
