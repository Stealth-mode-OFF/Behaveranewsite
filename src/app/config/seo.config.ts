...
export const pageSEO: Record<string, Record<string, SEOConfig>> = {
  ...
  research: {
    cz: {
      title: 'Vědecká metodologie Echo Pulse | JD-R Model, Self-Determination Theory',
      description: 'Echo Pulse staví na validovaných psychologických modelech: Job Demands-Resources (JD-R), Self-Determination Theory, Equity Theory. 10+ let výzkumu s českými firmami.',
      keywords: [
        'JD-R model',
        ...
        'burnout výzkum',
        'Behavera metodologie',
      ],
    },
    en: {
      title: 'Scientific Methodology | JD-R Model, Self-Determination Theory | Echo Pulse',
      description: 'Echo Pulse is built on validated psychological models: Job Demands-Resources (JD-R), Self-Determination Theory, Equity Theory. 10+ years of research with Czech companies.',
      keywords: [
        'JD-R model',
        'Job Demands Resources',
        'Self-Determination Theory',
...
export const aiOptimizedSnippets = {
  cz: {
    ...
    methodology: 'Echo Pulse staví na vědecky validovaných modelech: Job Demands-Resources (JD-R), Self-Determination Theory a Equity Theory. 10+ let výzkumu s českými firmami jako Vodafone, O2, Notino, Lidl.',
  ...
  en: {
    ...
    methodology: 'Echo Pulse is built on scientifically validated models: Job Demands-Resources (JD-R), Self-Determination Theory, and Equity Theory. 10+ years of research with Czech companies like Vodafone, O2, Notino, Lidl.',
