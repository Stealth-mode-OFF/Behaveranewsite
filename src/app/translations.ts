...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    faq: {
      ...
      contact: "Write to us →",
      items: [
        { q: "Will it annoy people?", a: "No. Each pulse takes 1–3 minutes and goes out once a month. It's not an 80-question annual survey — employees answer 5–7 short questions directly in the tools they already use (Teams, Slack, email). That's why we consistently see participation rates above 75 % without any pressure." },
        { q: "Does it require complex IT implementation?", a: "No. Behavera is a cloud service that connects to M365 or Slack with no involvement from your IT department. There's nothing to install on your servers, no integration project, and no changes to existing infrastructure. We can have you up and running within a week." },
        ...
        { q: "Is this just another HR tool I'll never open?", a: "Behavera is built for company leadership, not just HR. The CEO dashboard shows 3 key metrics: team risk, engagement trend, and action priority. It takes 2 minutes a week. This isn't a reporting system — it's a decision-making tool. And if it ever stops delivering value, cancel anytime — no lock-in." },
  ...
  cz: {
    ...
    faq: {
      ...
      contact: "Napište nám →",
      items: [
        { q: "Bude to lidi otravovat?", a: "Ne. Pulse průzkum trvá 1–3 minuty a chodí jednou za měsíc. Není to klasický 80otázkový dotazník — zaměstnanci odpovídají na 5–7 krátkých otázek přímo v prostředí, které už používají (Teams, Slack, e-mail). Díky tomu dosahujeme účasti přes 75 % bez jakéhokoli tlaku." },
        { q: "Vyžaduje to složitou IT implementaci?", a: "Ne. Behavera je cloudová služba, která se napojí na M365 nebo Slack bez zásahu vašeho IT oddělení. Není potřeba instalovat nic na server, řešit integrační projekt ani měnit stávající infrastrukturu. Spuštění zvládneme během jednoho týdne." },
        ...
        { q: "Není to jen další HR nástroj, který nikdo neotevře?", a: "Behavera je navržena pro vedení firmy, ne jen pro HR. CEO dashboard zobrazuje 3 klíčové metriky: riziko týmu, trend angažovanosti a prioritu akce. Zabere 2 minuty týdně. Není to reportovací systém, ale rozhodovací nástroj. A pokud vám přestane přinášet hodnotu, zrušíte kdykoli — žádný lock-in." },
  ...
  de: {
    ...
    faq: {
      ...
      items: [
        { q: "Wird es die Leute nerven?", a: "Nein. Jede Pulse-Umfrage dauert 1–3 Minuten und wird einmal im Monat verschickt. Es ist keine klassische 80-Fragen-Jahresumfrage — Mitarbeitende beantworten 5–7 kurze Fragen direkt in den Tools, die sie bereits nutzen (Teams, Slack, E-Mail). Deshalb erreichen wir konstant Teilnahmequoten über 75 %, ganz ohne Druck." },
        { q: "Erfordert es komplexe IT-Implementierung?", a: "Nein. Behavera ist ein Cloud-Service, der sich ohne Beteiligung Ihrer IT-Abteilung mit M365 oder Slack verbindet. Es muss nichts auf Ihren Servern installiert werden, kein Integrationsprojekt und keine Änderungen an der bestehenden Infrastruktur. Wir können Sie innerhalb einer Woche startklar machen." },
