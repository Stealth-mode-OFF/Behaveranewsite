...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    faq: {
      ...
      contact: "Write to us →",
      items: [
        { q: "Will it annoy people?", a: "No. Each pulse takes 1–3 minutes and goes out once a month. It's not an 80-question annual survey — employees answer 5–6 short questions directly in the tools they already use (Teams, Slack, email). That's why we consistently see participation rates above 80 % without any pressure." },
  ...
  cz: {
    ...
    faq: {
      ...
      contact: "Napište nám →",
      items: [
        { q: "Bude to lidi otravovat?", a: "Ne. Pulse trvá 1–3 minuty a chodí jednou za měsíc. Není to klasický 80otázkový dotazník — zaměstnanci odpovídají na 5–6 krátkých otázek přímo v prostředí, které už používají (Teams, Slack, e-mail). Díky tomu dosahujeme účasti přes 80 % bez jakéhokoli tlaku." },
        { q: "Vyžaduje to složitou IT implementaci?", a: "Ne. Behavera je cloudová služba, která se napojí na M365 nebo Slack bez zásahu vašeho IT oddělení. Není potřeba instalovat nic na server, řešit integrační projekt ani měnit stávající infrastrukturu. Celá implementace zabere do jedné hodiny — konkurenti potřebují týdny." },
  ...
  de: {
    ...
    faq: {
      ...
      items: [
        { q: "Wird es die Leute nerven?", a: "Nein. Jede Pulse-Umfrage dauert 1–3 Minuten und wird einmal im Monat verschickt. Es ist keine klassische 80-Fragen-Jahresumfrage — Mitarbeitende beantworten 5–6 kurze Fragen direkt in den Tools, die sie bereits nutzen (Teams, Slack, E-Mail). Deshalb erreichen wir konstant Teilnahmequoten über 80 %, ganz ohne Druck." },
        { q: "Erfordert es komplexe IT-Implementierung?", a: "Nein. Behavera ist ein Cloud-Service, der sich ohne Beteiligung Ihrer IT-Abteilung mit M365 oder Slack verbindet. Es muss nichts auf Ihren Servern installiert werden, kein Integrationsprojekt und keine Änderungen an der bestehenden Infrastruktur. Die gesamte Implementierung dauert unter einer Stunde — Wettbewerber brauchen Wochen." },
