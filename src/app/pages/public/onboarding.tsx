...
const copy = {
  cz: {
    ...
    steps: ["Společnost", "Kontakty", "Týmy", "Pozvánky", "Potvrzení"],
    // Step 1
    ...
    // Step 4 — Invite
    s4Title: "Pozvěte kolegy",
    s4Subtitle: "Přidejte kolegy, kteří budou s Echo Pulse pracovat.",
    // Step 5
    s5Title: "Potvrzení & spuštění",
    s5Subtitle: "Zkontrolujte údaje a potvrďte vytvoření účtu.",
  ...
  en: {
    ...
    steps: ["Company", "Contacts", "Teams", "Invite", "Confirm"],
    ...
    s4Title: "Invite teammates",
    s4Subtitle: "Add colleagues who'll work with Echo Pulse.",
    s5Title: "Confirm & launch",
    s5Subtitle: "Review the details and confirm account creation.",
  ...
  de: {
    ...
    steps: ["Unternehmen", "Kontakte", "Teams", "Einladung", "Bestätigung"],
...
export function OnboardingPage() {
  ...
  const [invitedTeammates, setInvitedTeammates] = useState<Array<{ email: string; name: string }>>([]);
