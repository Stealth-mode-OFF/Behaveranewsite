...
Další Pulse plánujeme na [datum]. Vaše zpětná vazba má smysl \u2014 díky! \ud83d\ude4f`,
  ...
  topicsList: [
    ...
    { emoji: "🤖", name: "AI v práci", desc: "Připravenost na AI, obavy, příležitosti", detail: "Zjistěte, jak váš tým vnímá umělou inteligenci v práci — kdo ji už využívá, kdo se bojí a kde vidí příležitosti. Klíčové pro strategické rozhodování o AI adopci.", useCases: ["Před zaváděním AI nástrojů", "Měření AI readiness týmu", "Identifikace AI šampionů a odpůrců"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-aiAtWork?x_lang=cs" },
    { emoji: "📈", name: "Pokrok", desc: "Pocit postupu, smysluplnost práce", detail: "Měří, zda lidé cítí, že se posouvají vpřed — profesně i osobně. Pocit pokroku je nejsilnější motivátor v práci.", useCases: ["Evaluace kariérního rozvoje", "Po reorganizaci nebo změně rolí", "Měření smysluplnosti práce"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-progress?x_lang=cs" },
    { emoji: "🔄", name: "Změny", desc: "Zvládání změn, adaptabilita", detail: "Odhalte, jak váš tým zvládá změny — od malých procesních úprav po velké transformace. Změnový management začíná pochopením, kde lidé jsou.", useCases: ["Před nebo po restrukturalizaci", "Při zavádění nových procesů", "Měření change fatigue"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-changes?x_lang=cs" },
    { emoji: "💬", name: "Komunikace", desc: "Informovanost, otevřenost, důvěra", detail: "Zjistěte, jestli informace proudí správným směrem. Měří kvalitu interní komunikace — od transparentnosti vedení po každodenní spolupráci v týmu.", useCases: ["Audit interní komunikace", "Po změně vedení nebo struktury", "Zlepšení cross-team spolupráce"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-communication?x_lang=cs" },
    { emoji: "💡", name: "Inovace", desc: "Prostor pro nápady, experimentování", detail: "Měří, zda firma vytváří prostředí pro inovace — jestli se lidé nebojí přijít s nápadem, zda mají prostor experimentovat a zda se nápady realizují.", useCases: ["Před spuštěním inovačního programu", "Měření psychologického bezpečí", "Identifikace bariér kreativity"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-innovations?x_lang=cs" },
    { emoji: "👑", name: "Leadership", desc: "Důvěra v lídry, styl řízení", detail: "Zjistěte, jak zaměstnanci vnímají své lídry — důvěru, kompetenci, empatii a styl řízení. Leadership je #1 faktor angažovanosti.", useCases: ["360° feedback pro management", "Po změně vedení", "Rozvoj leadership kompetencí"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-leadership?x_lang=cs" },
    { emoji: "🎯", name: "Priority", desc: "Jasnost cílů, zaměření týmu", detail: "Odhalte, zda lidé vědí, co je důležité — a zda to odpovídá strategii firmy. Nejasné priority = rozptýlená energie a frustrace.", useCases: ["Sladění týmových a firemních cílů", "Po strategickém plánování", "Identifikace konfliktů priorit"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-priorities?x_lang=cs" },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Mohu přizpůsobit témata?", a: "Ano, můžete si vybrat z 16 témat podle potřeb vašeho týmu. První Pulse doporučujeme Quick Scan pro celkový přehled." },
...
Next Pulse planned for [date]. Your feedback matters \u2014 thanks! \ud83d\ude4f`,
  ...
  topicsList: [
    ...
    { emoji: "🤖", name: "AI at Work", desc: "AI readiness, concerns, opportunities", detail: "Find out how your team perceives AI at work — who already uses it, who fears it, and where they see opportunities. Essential for strategic AI adoption decisions.", useCases: ["Before rolling out AI tools", "Measuring team AI readiness", "Identifying AI champions and skeptics"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-aiAtWork?x_lang=en" },
    { emoji: "📈", name: "Progress", desc: "Sense of advancement, meaningful work", detail: "Measures whether people feel they\u2019re moving forward — professionally and personally. A sense of progress is the strongest motivator at work.", useCases: ["Career development evaluation", "After reorganization or role changes", "Measuring work meaningfulness"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-progress?x_lang=en" },
    { emoji: "🔄", name: "Changes", desc: "Coping with change, adaptability", detail: "Reveal how your team handles change — from small process tweaks to major transformations. Change management starts with understanding where people are.", useCases: ["Before or after restructuring", "When introducing new processes", "Measuring change fatigue"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-changes?x_lang=en" },
    { emoji: "💬", name: "Communication", desc: "Transparency, openness, trust", detail: "Find out if information flows the right way. Measures the quality of internal communication — from leadership transparency to everyday team collaboration.", useCases: ["Internal communication audit", "After leadership or structural changes", "Improving cross-team collaboration"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-communication?x_lang=en" },
    { emoji: "💡", name: "Innovations", desc: "Space for ideas, experimentation", detail: "Measures whether the company fosters an environment for innovation — if people feel safe sharing ideas, have room to experiment, and see ideas come to life.", useCases: ["Before launching an innovation program", "Measuring psychological safety", "Identifying creativity barriers"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-innovations?x_lang=en" },
    { emoji: "👑", name: "Leadership", desc: "Trust in leaders, management style", detail: "Find out how employees perceive their leaders — trust, competence, empathy, and management style. Leadership is the #1 driver of engagement.", useCases: ["360° feedback for management", "After leadership changes", "Developing leadership competencies"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-leadership?x_lang=en" },
    { emoji: "🎯", name: "Priorities", desc: "Goal clarity, team focus", detail: "Reveal whether people know what matters — and whether it aligns with company strategy. Unclear priorities = scattered energy and frustration.", useCases: ["Aligning team and company goals", "After strategic planning", "Identifying priority conflicts"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-priorities?x_lang=en" },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Can I customize topics?", a: "Yes, you can choose from 16 topics based on your team\u2019s needs. We recommend Quick Scan first for a full overview." },
...
N\u00e4chster Pulse geplant f\u00fcr [Datum]. Ihr Feedback ist wichtig \u2014 danke! \ud83d\ude4f`,
  ...
  topicsList: [
    ...
    { emoji: "🤖", name: "KI bei der Arbeit", desc: "KI-Bereitschaft, Bedenken, Chancen", detail: "Erfahren Sie, wie Ihr Team KI bei der Arbeit wahrnimmt — wer sie bereits nutzt, wer Bedenken hat und wo Chancen gesehen werden. Entscheidend für strategische KI-Adoption.", useCases: ["Vor der Einführung von KI-Tools", "Messung der KI-Bereitschaft im Team", "Identifizierung von KI-Champions und Skeptikern"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-aiAtWork?x_lang=de" },
    { emoji: "📈", name: "Fortschritt", desc: "Gefühl des Vorankommens, sinnvolle Arbeit", detail: "Misst, ob Menschen das Gefühl haben, voranzukommen — beruflich und persönlich. Ein Gefühl des Fortschritts ist der stärkste Motivator bei der Arbeit.", useCases: ["Bewertung der Karriereentwicklung", "Nach Reorganisation oder Rollenwechsel", "Messung der Arbeitssinnhaftigkeit"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-progress?x_lang=de" },
    { emoji: "🔄", name: "Veränderungen", desc: "Umgang mit Wandel, Anpassungsfähigkeit", detail: "Erfahren Sie, wie Ihr Team mit Veränderungen umgeht — von kleinen Prozessanpassungen bis zu großen Transformationen. Change Management beginnt mit dem Verständnis, wo die Menschen stehen.", useCases: ["Vor oder nach Umstrukturierung", "Bei Einführung neuer Prozesse", "Messung von Change Fatigue"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-changes?x_lang=de" },
    { emoji: "💬", name: "Kommunikation", desc: "Transparenz, Offenheit, Vertrauen", detail: "Erfahren Sie, ob Informationen richtig fließen. Misst die Qualität der internen Kommunikation — von der Führungstransparenz bis zur täglichen Teamzusammenarbeit.", useCases: ["Audit der internen Kommunikation", "Nach Führungs- oder Strukturwechsel", "Verbesserung der teamübergreifenden Zusammenarbeit"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-communication?x_lang=de" },
    { emoji: "💡", name: "Innovationen", desc: "Raum für Ideen, Experimentieren", detail: "Misst, ob das Unternehmen ein innovationsfreundliches Umfeld schafft — ob Menschen sich trauen, Ideen einzubringen, Raum zum Experimentieren haben und ob Ideen umgesetzt werden.", useCases: ["Vor dem Start eines Innovationsprogramms", "Messung der psychologischen Sicherheit", "Identifizierung von Kreativitätsbarrieren"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-innovations?x_lang=de" },
    { emoji: "👑", name: "Führung", desc: "Vertrauen in Führungskräfte, Führungsstil", detail: "Erfahren Sie, wie Mitarbeiter ihre Führungskräfte wahrnehmen — Vertrauen, Kompetenz, Empathie und Führungsstil. Leadership ist der #1-Faktor für Engagement.", useCases: ["360°-Feedback für das Management", "Nach Führungswechsel", "Entwicklung von Leadership-Kompetenzen"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-leadership?x_lang=de" },
    { emoji: "🎯", name: "Prioritäten", desc: "Klarheit der Ziele, Team-Fokus", detail: "Erfahren Sie, ob die Menschen wissen, was wichtig ist — und ob es mit der Unternehmensstrategie übereinstimmt. Unklare Prioritäten = verstreute Energie und Frustration.", useCases: ["Abstimmung von Team- und Unternehmenszielen", "Nach strategischer Planung", "Identifizierung von Prioritätenkonflikten"], demoUrl: "https://bibi.behavera.com/free/behiro/pulse-showcase-priorities?x_lang=de" },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Kann ich Themen anpassen?", a: "Ja, Sie k\u00f6nnen aus 16 Themen basierend auf den Bed\u00fcrfnissen Ihres Teams w\u00e4hlen. Wir empfehlen zuerst Quick Scan f\u00fcr einen Gesamt\u00fcberblick." },
