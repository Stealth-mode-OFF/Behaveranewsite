      ...
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-brand-border">
        ...
        {isCz ? (
            ...
            <section id="privacy" className="pt-8 mt-8 border-t border-brand-border">
                <h2 className="text-xl font-bold mb-4">Ochrana osobních údajů</h2>
                ...
                <h3 className="text-lg font-bold mb-3">Kdo je správcem vašich osobních údajů?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Komisař pro ochranu osobních údajů</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Proč zpracováváme vaše osobní údaje?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Jaké osobní údaje zpracováváme?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Jak je to s automatizovaným rozhodováním a profilováním?</h3>
                <p className="mb-4">
                    Vaše osobní údaje nepodléhají automatickému rozhodování, včetně profilování ve smyslu čl. 22 odst. 1 a 4 nařízení GDPR.
                </p>

                <h3 className="text-lg font-bold mb-3">Komu předáváme vaše osobní údaje?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Jak dlouho vaše osobní údaje zpracováváme?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Kontaktujte nás a požádejte o přístup k vašim údajům, jejich přenos a vymazání</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Jaká jsou vaše práva?</h3>
                <p className="mb-4">
        ...
        <div className="space-y-8 text-brand-text-primary leading-relaxed">
            ...
            <section id="privacy" className="pt-8 mt-8 border-t border-brand-border">
                <h2 className="text-xl font-bold mb-4">Protection of personal data</h2>
                <p className="mb-4 text-brand-text-secondary">
                ...
                <h3 className="text-lg font-bold mb-3">Who is the Administrator of your personal data?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Commissioner for the protection of personal data</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Why do we process your personal data?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">What personal data do we process?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">What about automated decision making and profiling?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">To whom do we transfer your personal data?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">How long do we process your personal data?</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">Contacting us to request access, transfer, and deletion of your data</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-bold mb-3">What are your rights?</h3>
                <p className="mb-4">
