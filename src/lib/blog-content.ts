...
<p>Naslouchají a berou zpětnou vazbu vážně Jasně komunikují očekávání a odpovědnosti Zajišťují potřebné zdroje a nástroje Koučují místo kontrolování Komunikují autenticky Upřímně se zajímají o well-being svého týmu Oceňují a oslavují a rozvoj a úspěch Nabízí příležitosti k smysluplné práci</p>
...
<p>Téměř 60 % vedoucích pracovníků považuje za důležité porozumět individuálním motivacím a potřebám svých zaměstnanců a přizpůsobit jim práci tak, aby dosáhli nejvyššího výkonu.</p>
...
<p><em>Dobrá zpráva je, že to jde i chytřeji</em>! Jak rozpoznat skutečný talent ještě před tím, než zavolá prvnímu zákazníkovi? Najímat někoho, kdo nesplňuje očekávání, není jen frustrující - je to nákladné. Podle studie společnosti Accenture stojí</p>
...
<p>snadno použitelný nástroj měřící</p>
...
<p>Každý špatný nábor v obchodním oddělení stojí firmu tržby, zpomaluje růst a frustruje vedení i tým. Rozdíl mezi týmy, které se potýkají s problémy, a těmi vysoce výkonnými není ve štěstí - je to v identifikaci a investici do lidí se správným myšlením a kompetencemi od samého začátku . Behavera odstraňuje nejistotu při náboru zaměstnanců a poskytuje jasný, daty podložený přehled o tom, kdo bude ve Vaší organizaci a na dané pozici úspěšný. Díky našim herním simulacím a chatbotu se můžete přestat spoléhat na instinkty a</p>
...
<p>Pre-screening was handled by a law student—very intelligent and capable , but not a trained recruiter. Her notes often included not only practical information but also subjective opinions, such as how the candidate came across to her. However, such information is not relevant for a hiring manager and can unnecessarily influence their decision. Additionally, the process was time-consuming for her, taking up almost half of her working hours. Hiring managers, often with little recruitment experience themselves, would enter interviews without a clear plan—they didn’t know exactly what they were looking for or how to evaluate candidates.</p>
...
<p>Úspora 1/4 úvazku a 20 tisíc měsíčně</p>
...
<p>Pokud se některý atribut výrazně odchyluje, vnímáme to jako červenou vlajku. "Ignorovali jsme varování Behavery a rychle jsme na to doplatili – od té doby už datům věříme."</p>
...
<p><em>„Z pohledu leadera týmu mám tyto schůzky docela rád</em>, baví mě to, baví mě posouvat lidi, posouvat sebe a baví mě vidět pokrok,“ prozradil náš Dušan Murčo . Jak často dělat 1:1? To záleží na velikosti týmu , agendě a jestli fungujete v remote či office módu. „Mně osobně nejlépe vyhovuje týdenní struktura, protože jelikož nejsme ve stejné kanceláři, mám čas zjistit, jak se lidem v týmu daří a co prožívají nejen v práci, ale i mimo ni.</p>
<p><em>Pomáhá mi to lépe pochopit nevyřčené věci – jejich osobnost a často i důvody jejich postojů nebo rozhodnutí</em>. Takže to určitě doporučuji, zejména v remote prostředí,“ vysvětlila Eva Kianičková , Head of Customer Care in CEE, Websupport/Loopia. Jakub Žilinčan , VP of Global Marketing, Berlin Brands Group, se 1:1 věnuje 4-6 hodin týdně a používá různé typy schůzek podle agendy. „Kvantitativně a strukturovaně prostřednictvím měsíční "pulse checks týmu", kvalitativně prostřednictvím nestrukturované diskuse 1:1 a v neposlední řadě na příležitostných offsitech, kde se můžete v uvolněné atmosféře naučit nejvíce.“ Co řešit na 1:1?</p>
<p>Základem je mít jasnou agendu , aby byl meeting produktivní a byla nastavená jasná očekávání. „Pro mě je 1:1 o dvou základních věcech: o zpětné vazbě a rozvoji lidí . S novými lidmi jsem to vedl já, ale po nějaké době jsme se dostali do bodu, kdy lidé vedli 1:1 trochu sami – tak na to byli lépe připraveni a bavilo je to. Když to má jasný program, mohou si vzít celý měsíc na to, aby získali zpětnou vazbu o tom, co chtějí říct, a skutečně si připravit poznámky dopředu,“ doporučuje Dušan Murčo.</p>
<p>Na 1:1 však nemusíte řešit jen náplň práce, je to příležitost pro získání cenného feedbacku, kterého by se leadeři neměli bát. „Já bych doplnila nejen feedback na zaměstnance, ale i zájem o jeho feedback na firmu, pracovní náplň, úkoly, a další. 1:1 mi připadá jako skvělá příležitost, jak případně podchytit nespokojenost zaměstnance v době, kdy s ní ještě můžu něco udělat. A spousta leaderů se feedbacku prostě bojí – protože co kdybych se dozvěděl, že je zaměstnanec nespokojený.</p>
<p>Souhlasím s nasloucháním – často máme tendenci 1:1 prosvištět podle agendy v Excelu, checknout KPIs a nezajímat se. Ale mělo by to být právě tím setkáním, na kterém není nikdo jiný z týmu, který by byl slyšet víc nebo se přihlásil o slovo rychleji. A abych mohl/a kolegovi naslouchat, musím já umět mlčet," radí Barbora Malinovská , koučka, mentorka a školitelka na volné noze. Další důležitou ingrediencí dobrých 1:1 meetingů je zhodnocení pokroku , ať už pracovním, tak rozvojovým. Na co se tedy mrknout?</p>
<p>„Podívat se na to, co zaznělo na posledním 1:1 a říct si, jaký je aktuální stav, kam se posunulo, jaký význam to má, např. pro naplnění osobních cílů, co se změnilo, být férový. A samostatnou kapitolou je naslouchání a vyjasňování (naslouchat pro porozumění než reagování, i pokud chceme dávat užitečnou zpětnou vazbu), dávat prostor, nebát se ticha a následně to dát na "papír",” dodává koučingový pohled na 1:1 Lenka Karlíková , Life & Business Coach (ACC, ICF) a Trainer. Čeho se vyvarovat? Nepravidelnost meetingů.</p>
<p>Nedělejte je podle toho, kdy se vám to zrovna hodí, protože to dá lidem pocit nespolehlivosti. Na druhou stranu, všichni jsme jen lidi a jsou situace, kdy nedává smysl tlačit na pilu a za každou cenu trvat na tom, aby se meeting konal. „Souhlasím s pravidelností a je to ideální top stav, ale (!) jsou chvíle, kdy opravdu vidím, že by lidem v mém čase prospěla větší pauza.</p>
<p>Pak necháváme v kalendáři týdenní 1:1 , ale posílám je v tu dobu ven, aby si dali kávu, šli na procházku, četli si, hráli v herně, prostě si vyčistili hlavu bez rizika, že jim někdo ten čas vyplní dalším problémem k řešení. Někdy je to prospěšnější, než když mě přemlouvají, ale opravdu je třeba dobře zasáhnout, když je to potřeba. Nebát se porušovat pravidla (i ta vlastní) je pro mě dobrá leaderská vlastnost,“ s upřímností prozradila Eva Kianičková. Jinými slovy, meetingy mějte naplánované předem , ať s nimi obě strany mohou počítat.</p>
<p>Ale nerušte je, pokud to není naprosto nezbytné. Další věcí, které je radno se vyvarovat, je duševní nepřítomnost . Pokud se během meetingu díváte do telefonu, nevědomky tím dáváte druhé straně najevo, že pro vás není dostatečně důležitá natolik, abyste jí věnovali svou plnou pozornost . Žijeme v době roztříštěné pozornosti, notifikace na nás skáčou zleva zprava, a tak se umění být přítomném okamžiku stává superschopností. Pro leadery toto platí dvojnásob. „Buďte "tam". Nedělejte během toho nic jiného, nezvedejte telefon, nedělejte notifikace, nedělejte multitasking (zejména pokud máte 1:1 jako remote call).</p>
<p>Buďte tam pro člena svého týmu,“ dodává Dušan Murčo. „Ono, už jen ten signál, že je telefon na stole, je špatný. Změňte prostředí – dělejte ty schůzky mimo kancelář. Jděte na procházku nebo vyběhněte někam na kávu/koláč/atd.,“ dodává Michal Dragan , Head Of Digital, Slovakia Travel. Co udělat s výstupy z 1:1? Co je psáno, to je dáno. „Dělejte si poznámky a uložte je na disk, abyste se k nim mohli oba vrátit. Pokud z nich vyplývají jasné kroky, které máte jako leader podniknout – pracujte na nich.</p>
<p>Protože pokud to přijde nazmar, lidé přestanou mít rádi 1:1 a budou mít pocit, že to nemá smysl. Příští schůzku 1:1 můžete zahájit třeba tím, o čem jste mluvili minule a kam to vedlo,“ doporučuje Dušan Murčo. Pokud máte v týmu seniornější lidi, pravděpodobně jsou zvyklí si dělat vlastní poznámky a organizovat si práci samostatně . Budou však potřebovat vědět, co jsou priority (například následovat Eisenhowerův princip nebo kteroukoliv z dalších metod) a jaký je kontext daných úkolů, aby se dokázali samostatně pracovat.</p>
<p>Juniorům a nováčkům je potřeba dát více podpory bez toho, abyste je mikromanagovali. Kromě poznámek z meetingu bude fajn vytvořit konkrétní úkoly se zadáním a vést je k tomu, aby byli schopni si úkoly zpracovávat sami jako jejich seniornější kolegové. Na co se vlastně týmu ptát? Dobré otázky jsou základ. Bez nich se může stát, že bude konverzace váznout a nevyřešíte to, co máte v agendě . „Ještě bych přidal tematické okruhy. Stále mám připravenou sadu otázek, které sledují well-being , protože to je pro mě to podstatné na 1:1.</p>
...
<p class="lead"><strong>It depends on the company culture and whether the organization has a psychologically safe environment</strong>. If employees have the experience that anything they say will be used against them, then they may be reluctant to participate in surveys other than anonymously. Conversely, in companies where the culture is based on mutual trust, honesty, and cooperation, the need for anonymous surveys is almost non-existent. People are not afraid to share their opinions and want to be actively involved in the development of the company.</p>
<p><strong>The compromise is to give employees the choice of whether or not they want to disclose their names</strong>. Anonymous surveys have their limits. While you will find out what employees are concerned about, the opportunities to make changes will be limited. Some problems have universal solutions, but individual or team problems will be much harder to solve and require detective work.</p>
<p>:) At Behavera, we believe that non-anonymous surveys are a better way to go . To be able to put its people first, a company needs to approach well-being solutions with openness and honesty. Feedback is a gift to be valued and goes hand in hand with a willingness to look at the problem from a different perspective. In the daily hustle and bustle, management may inadvertently overlook small issues that can build up over time. Feedback will help shine a light on these issues before they become serious problems.</p>
<p>When an employee speaks up and discloses their name, you know who to go to for more information and learn a lot. You can include your people in problem-solving and the whole process helps build trust, strengthens relationships, and makes people feel heard and valued. Which is one of the key ingredients to happiness at work. Do you want to try the Behavera Well-being Index?</p>
<p>Sign up here .</p>
<h2>2) Doing a survey once a year is enough</h2>
<p><strong>A year is a very long time and we live in a world where things change rapidly</strong>. If you do surveys once a year, you'll know what the state of well-being is right now, but it won't give you an evaluation of the whole year. Few of us remember how we felt a week, a month, or six months ago. Just try to remember what you were doing a year ago at this time.</p>
<p><em>You should survey well-being ideally on a quarterly basis</em>, and in the meantime do pulse checks (a few short questions instead of a long survey). You can then compare the data over time and notice patterns or more challenging periods. This way you can plan better and catch problems before they flare up into a critical situation. Flexibility, adaptability, and quick reactions are the cornerstones of today's success. And this is much easier to do with data than without it.</p>
<p><em>On the other hand</em>, surveys are not to be overdone or they will annoy people. Every company has different needs and it&#x27;s perfectly fine to try doing surveys every month in the beginning. Listen to your people and monitor your completion rates. Then set the frequency of surveys as it suits your needs.</p>
<h2>3) Well-being needs to be addressed only when there is a problem</h2>
<p>With well-being, it's like preventive check-ups at the doctor. We all know we should go regularly, but we usually skip it until we have a serious problem. Prevention would save us a lot of time, money, and heartache, but we only take it seriously when it's too late. It works the same way in companies, where well-being is only addressed when key people leave due to burnout and a tsunami of other problems arises.</p>
<p>Starting to address well-being at this point may not save you from existing problems, but it will help you see early on where new ones may arise and prevent future problems.</p>
...
<p>Surveys are a great start. People-first companies wanted to lend a helping hand to their people during the pandemic, and self-produced surveys were the most accessible option. This difficult task fell on the shoulders of HR professionals and leaders who tackled it as best they could. However, times have evolved and there are HR technologies on the market, such as Behavera, that combine insights from behavioral psychology with data science to take surveys to the next level.</p>
<p>Why replace custom surveys with an HR platform? Surveys are a lot of work for little data. You will spend hours compiling surveys, chasing colleagues to complete them, and then analyzing the results. Which is expensive for companies and keeps HR professionals busy on tasks they may not enjoy or find fulfilling. Behavera does this work for you and you can spend your time focusing on helping people.</p>
...
<p>Great news, we'd like to introduce the Behavera Well-being Index, your people-first tool for a happier company. How does it all work? You'll get an Echo chatbot that your team can talk to in 15 minutes to find out how much and in what areas people are calling for help. In the report, you'll see up to 12 of the highest-risk areas, the overall score, and the completion rate.</p>
<p>At the same time, for each risk area, you'll get tips from behavioral psychologists on how to approach the problem. The Behavera Well-being Index will do the research for you, analyze the data, and advise you on how to manage it all. Do you address well-being in your company?</p>
...
<p class="lead"><strong>To záleží na firemní kultuře a jestli je v organizaci vybudované psychologicky bezpečné prostředí</strong>. Pokud mají zaměstnanci zkušenost, že cokoliv řeknou, bude použito proti nim, pak se mohou zdráhat se průzkumů účastnit jinak než anonymně. Naopak u firem, kde je kultura založená na vzájemné důvěře, upřímnosti a spolupráci, potřeba anonymních dotazníků téměř neexistuje. Lidé se nebojí sdílet své názory a chtějí se aktivně zapojovat do rozvoje firmy. Kompromisem je dát zaměstnancům volbu, jestli se chtějí nebo nechtějí podepsat. Anonymní dotazníky totiž mají své limity.</p>
<p><strong>Dozvíte se sice, co zaměstnance trápí</strong>, ale možnosti udělat změny budou omezené. Některé problémy mají plošná řešení, ale ty individuální či týmové půjdou vyřešit mnohem hůř a vyžadovat detektivní práci. :) V Behaveře věříme, že neanonymní dotazníky jsou lepší cesta.</p>
<p>Aby byla firma schopná dát své lidi na první místo , potřebuje přistupovat k řešení well-beingu s otevřeností a upřímností. Feedback je dar, kterého je třeba si vážit a jde ruku v ruce s ochotou podívat se na problém z jiného úhlu pohledu. V každodenním shonu může vedení neúmyslně přehlížet drobné problémy, které se časem mohou nakupit. Feedback pomůže posvítit na tyto problémy ještě než se tak stane. Když na to poukáže zaměstnanec svým jménem, víte za kým přijít pro více informací a hodně se naučit.</p>
<p>Můžete své lidi zahrnout do řešení problémů a celý proces pomáhá budování důvěry, utužuje vztahy a lidé se cítí vyslyšení a docenění. Což je jeden z hlavních předpokladů ke spokojenosti v práci. Chcete si vyzkoušet Behavera Well-being Index?</p>
<p>Zaregistrujte se zde .</p>
<h2>2) Dělat průzkum jednou ročně je dostatečné</h2>
<p><strong>Rok je velmi dlouhá doba a žijeme ve světě</strong>, kde se věci rychle mění. Pokud děláte průzkumy jednou ročně, tak se dozvíte jaký je stav well-being právě teď, ale nevyhodnotí vám to celý rok. Jen málokdo z nás si pamatuje, jak se cítil týden, měsíc či půlrok dozadu. Schválně si vzpomeňte, co jste dělali před rokem touhle dobou. Je potřeba zkoumat well-being ideálně čtvrtletně a mezitím dělat tzv.</p>
<p><em>pulse checks (pár krátkých otázek místo dlouhého průzkumu)</em>. Data za jednotlivá období si pak můžete porovnat a všímat si vzorců či náročnějších období. Dokážete tak lépe plánovat a hasit problémy ještě než vzplanou v kritickou situaci. Flexibilita, přizpůsobivost a rychlé reakce jsou základním kamenem úspěchu současnosti. A to se dělá mnohem snadněji s daty než bez nich.</p>
<p><em>Na druhou stranu se to s průzkumy nemá přehánět nebo se lidem zprotiví</em>. Každá firma má jiné potřeby a je úplně v pořádku si na začátku vyzkoušet dělat průzkumy třeba i každý měsíc. Naslouchejte svým lidem a sledujte míru vyplnění. Četnost průzkumů si pak nastavte jak to vyhovuje vám.</p>
<h2>3) Well-being je potřeba začít řešit až když je problém</h2>
<p>S well-beingem je to jako s preventivními prohlídkami u lékaře. Všichni víme, že bychom na ně měli pravidelně chodit, ale většinou se na to vykašleme dokud nás nepotká nějaký závažný problém. Prevence by nám ušetřila spoustu času, peněz i trápení, ale bereme ji vážně až když je pozdě. Úplně stejně to funguje ve firmách, kde well-being řeší až ve chvíli, kdy jim kvůli vyhoření odejdou klíčoví lidé a strhne se tsunami dalších problémů..</p>
<p>Začít v tuto chvíli řešit well-being vám sice nezachrání existující problémy, ale pomůže vám včas vidět, kde mohou vzniknout nové a zabránit dalším problémům v budoucnosti.</p>
<p>Firmy nám často říkají, že změří well-being, až se věci ve firmě trochu uklidní. Někdy to zdůvodňují tím, že nechtějí přidávat svým lidem další úkol. Jindy se tak trochu bojí toho, co se dozví. Každopádně měřit well-being jen v klidných obdobích vám nedá pravdivá data, která by odrážela realitu. Řešení well-beingu jako prevenci problémů pomáhá budovat stabilnější a silnější firmy, které dokážou lépe překonávat překážky. Dlouhodobě se to promítá i na výkonu a efektivitě lidí.</p>
...
<p><strong>The importance of well-being is finally dawning on executives and 89% [1] of c-level leaders have it as a priority</strong>. However, they themselves are not immune and the impact of the events of the last three years has taken its toll on them as well.</p>
<p><strong>70% [1] of leaders are even considering changing jobs if they can find one that allows them a healthier lifestyle and more flexibility</strong>. They realize that in order to perform well in their role, well-being needs to start with themselves.</p>
<p><strong>"We believe that when leaders take care of themselves</strong>, they are much more able to take care of their employees to be empathetic, creative, and inspiring. But when they're depleted, running on empty and burnt out, it's much harder to lead from what is best in them. Role modeling is key because we are changing an entire culture that used to believe that burnout is simply the price you pay for success," Arianna Huffington revealed in an interview with Forbes [2] .</p>
<p><em>Changing priorities and making an effort to change are a great start and a significant step toward a healthier lifestyle</em>. However, leaders recognize that navigating this new path will not be easy , and the main obstacle is the current way of working. The main villains are a high volume of work and a stressful agenda next to long hours. It is common for leaders not to take the vacation time needed to recover because of "work that won't wait".</p>
<p>Will we be able to build a bridge across the gap between the need to address well-being and the reality of the workplace? Where there is a will, there is a way. Technology could be part of the solution . "We believe that the time is coming when work will adapt to our lifestyle instead of adapting our lifestyle to work. This is a fundamental mindset shift that will require companies to take a different approach toward workers.</p>
<p>Not only with the advent of applied AI, but it will also be more about changing the paradigm from 'work hard' to 'work smart'," predicts Tomáš Jiroušek, Investment Manager at MITON Group. How can leaders get started with well-being? "We often refer to the phrase 'work hard, play hard', but this is the time when 'rest well' deserves to be added. Find a sustainable model between stress and rest, because you also want to be a functional part of your team for as long as possible," recommends Behavera's Dušan Murčo, who summarizes practical tips on leading people remotely in his Remote Leadership Manifesto.</p>
<p>Working and leading people requires a lot of energy. Dušan recommends that leaders create routines that will help recharge your batteries during the workday. Whether it's a phone call with loved ones, breathing exercises, a healthy snack, or whatever else works for you. Experiment and get to know yourself through it.</p>
<p>Allow yourself to not drive yourself to the ground and forget about yourself . "Don't postpone it. Start and do it regularly, put it on your calendar, and focus on it," he added. In addition to routines and small habits, you can start working on changing your overall approach to work . If your calendar is quickly filled with work obligations, you don't have the space to schedule quality time with family, sports, or time for deep work. You need to take the opposite approach and set boundaries.</p>
<p>Prioritize time off for family and hobbies first on the calendar, block out time for sports activities, and finally time for uninterrupted deep work. Next, carve out time to dedicate only to your team and open the remaining capacity to other work responsibilities. It is the opposite approach to what many can even imagine. However, leaders who have changed their approach to work and their order of priorities are not as at risk of burnout and have better levels of well-being. How to take care of your team's well-being?</p>
...
<p class="lead"><strong>How do the world&#x27;s experts view the current challenges in HR</strong>? And what solutions do they offer? We can look forward to speakers from companies such as Patagonia, Bank of Ireland, Wella, Udemy Business, Britvic, and others. The event is free to attend and the program will take a nice broad look at topics that are on the minds of perhaps every HR professional.</p>
<p>When: 28 February 2023 Where: Online Website:</p>
<p><em>hrdcollective.org/europe FORWARD 2023 The global conference from Hacking</em> HR boldly claims to be the most important HR event in the world. They&#x27;ve invited the biggest thought leaders to share insights, data, stories, knowledge, and more. Sounds like quite a ride, see you there?</p>
<p>When: 6-9 March 2023 Where: Online Website:</p>
<p><em>hackinghrlab.io HR and Future of Work Technology is a catalyst for huge changes in business and the way we work</em>. The HR Exchange Network hosts several events throughout the year and they are free. This one focuses on the future of work and you will learn about topics such as upskilling, benefits relevant to the current times, metaverse, employee data, and how to ensure engagement in the future.</p>
...
`,
    content_cz: `
<p>HRD Collective Europe</p>
<p class="lead"><strong>Jak se světoví experti staví k momentálním výzvám v HR</strong>? A jaká řešení nabízí? Těšit se můžeme na speakery z firem jako je Patagonia, Bank of Ireland, Wella, Udemy Business, Britvic a další. Akce je zdarma a program se hezky zeširoka zaměří na témata, kterými si láme hlavu snad každý HR profesionál.</p>
<p>Kdy: 28. února 2023 Kde: Online Web:</p>
<p><em>hrdcollective.org/europe FORWARD 2023 Globální konference z dílny Hacking HR odvážně tvrdí</em>, že se jedná o tu nejdůležitější HR akci na světě. Pozvali ty největší thought leadery, kteří se podělí o insighty, data, příběhy, znalosti a další. To vypadá jako pořádá jízda, vidíme se tam?</p>
<p>Kdy: 6. – 9. března 2023 Kde: Online Web:</p>
<p><em>hackinghrlab.io HR and Future of Work Technologie jsou katalyzátorem obrovských změn v byznysu i způsobu práce</em>. HR Exchange Network pořádá hned několik akcí během roku a to zdarma. Tato se zaměřuje na téma budoucnosti práce a dozvíte se například o zvyšování kvalifikace (upskilling), benefity relevantní pro dnešní dobu, metaverse, data o zaměstnancích a jak zajistit angažovanost i v budoucnosti.</p>
...
<p class="lead"><strong>Surveys are great to start with because it&#x27;s a free solution</strong>. Most companies that have already started to address well-being have reached for custom surveys as a first solution. However, creating surveys is not without its hidden costs. Putting together a good survey with good questions is quite a challenge.</p>
...
<p><em>they&#x27;re boring</em>. Answering the questions is a passive activity that gets old very quickly. Companies often find that after just a few surveys are sent out, the completion rate drops rapidly. The effort expended is then not a return on investment.</p>
<p><em>The solution? A chatbot with which the employee has an active conversation similar to a discussion on Slack or another messenger</em>. It&#x27;s a modern way to humanize surveys and make them more fun.</p>
...
<p class="lead"><em>Dotazníky jsou pro začátek super</em>, protože je to dostupné řešení zdarma. Většina firem, která už začala řešit well-being, sáhla po vlastní dotaznících jako prvním řešení. Avšak tvorba dotazníků má plno skrytých nákladů. Sestavit kvalitní dotazník s dobrými otázkami je docela majstrštyk.</p>
...
<p><em>že jsou nudné. Odpovídání na otázky je pasivní činnost</em>, která se velmi rychle zprotiví. Firmy často řeší, že se už po pár zaslaných dotaznících rapidně klesá míra vyplnění.. Vynaložené úsilí pak není návratná investice.</p>
...
<p>Transparentnost a otevřenost pomáhají budovat důvěru. Otevřete prostor otázkám a návrhům. Zapojte dobrovolníky do procesu změn. Sdílejte pak i proces změn, úspěchy i neúspěchy. Snaha se cení více než perfektní výsledky. Nezapomeňte průzkum opakovat. Doporučujeme nechat zaměstnance si popovídat s naším chatbotem Echo nejméně jednou za čtvrt roku. V přehledu pak budete moct sledovat, jak se vaše well-being skóre vyvíjí v čase a jak tedy fungují zavedené změny. Máte nějaké otázky na Behavera Well-being Index? Napište nám na hello(at)behavera.com a rádi vám vše vysvětlíme.</p>
`,
...
<p><em>celkově spokojení se svým životem po osobní i profesní stránce</em>. Je to stav, který je neustále proměnný a můžeme ho ovlivnit pomocí naučitelných dovedností podobně jako třeba pracujeme na svých měkkých dovednostech.</p>
<p><em>Firmy by měly považovat well-being za hmatatelnou dovednost</em>, kritický přínos pro podnikání a měřitelný výsledek. Je důležité, aby si leadeři vážili well-beingu svých lidí stejně jako si váží jejich dovedností. Dva roky pandemie dolehly na každého z nás a mají přímý vliv na produktivitu v práci. Podle průzkumu</p>
...
<p>During the pandemic, it became apparent that simply closing a laptop at the end of the day in the home office environment wasn't enough to mentally disconnect from work. People often check email and Slack on their mobile phones, thinking that 'just in case' someone was looking for them.</p>
<p>However, the lack of continuous availability is a result of a lack of communication of expectations. And if messages from the boss are coming in at 10 pm, then he's not exactly setting a good example. A healthy work-life balance contributes to employee well-being, and satisfaction leads to greater engagement.</p>
...
<p><em>Komunikace je jako kyslík a bez něho se neobejdeme</em>, ani ve firemním prostředí. Hybridní model práce vyžaduje častou komunikaci, i když si myslíte, že všem už musí být všechno jasné. Váš tým může fungovat asynchronně a úroveň technologických dovedností se může lišit. Zaměstnanci, kteří nemají potřebné informace nebo se cítí odstrčeni, se nebudou angažovat.</p>
<p><em>V Behaveře vykopáváme každé úterý all-hands meetingem Tuesday Rocks</em>, kde každý tým na jednom slidu poví, na čem právě dělá. Všichni tak víme, co se děje a nechybí nám kontext toho, na čem jako celá firma pracujeme.</p>
...
<p>Ve svém TED Talku Adam Grant nabídl hned několik praktických tipů, jak vytvořit ideální prostředí pro tyto ideální zaměstnance a jak je ochránit (před sebou samotnými i před ostatními skupinami lidí). „Nejsmysluplnější způsob, jak uspět, je pomáhat druhým uspět.“ – Adam Grant Matt Mullenweg: Proč je práce z domova dobrá pro podnikání Podle posledních průzkumů jsou remote zaměstnanci o 13 % produktivnější než ti, co docházejí do kanceláře. Proč? Vliv na to má jejich pracovnímu prostředí , které si mohou přizpůsobit dle svých potřeb.</p>
...
<p>According to recent research, young people change between 12-15 jobs in their working lives. In other words, talent will always go for the best offer, and often this will be abroad without having to emigrate from their home country. Technology allows people to work anytime, anywhere.</p>
<p>For companies, this will have to mean adapting processes, from recruitment to actual operations. And for people, a change of mindset from a single occupation to career mobility and from specialization to transferable skills. But how individual countries will manage to adapt their labor codes is still a big question mark.</p>
...
<p class="lead"><strong>Životopis vám prozradí minulé zkušenosti</strong>, ale už nezjistíte jaký potenciál kandidát skutečně má. A právě to vám odhalí</p>
<p><strong>pracovní kompetence</strong>, které jsou souhrnem chování, vědomostí, dovedností, schopností, postojů a hodnot potřebných pro zastávání dané pracovní pozice.</p>
...
<p><em>Nový trend v zaměstnatelnosti už nebude jen o soft skills</em>, jako komunikace, schopnost spolupráce, kritické myšlení a emoční inteligence. K nim se přidávají právě digitální dovednosti a s nimi spojená adaptovatelnost na rychlé změny.</p>
