...
export const BLOG_POSTS: BlogPost[] = [
  ...
  /* ───────────────────────── 1 ───────────────────────── */
  {
    ...
    content: `
<p class="lead">You may have spent years as an expert in your field, the person others relied on because you knew how things worked. Then came the offer:</p>
...
`,
    content_cz: `
<p class="lead">Dlouho jste pracovali jako specialisti a lidé se na Vás obraceli, protože víte, jak věci fungují. A pak přišla nabídka: „Nechcete vést tým?“ Zní to logicky – rozumíte práci, máte zkušenosti, znáte prostředí firmy. Jenže role lídra není jen „vyšší level“ Vaší dosavadní kariéry. Je to úplně nová disciplína. Už nejde jen o to být odborníkem, ale hlavně o práci s lidmi. Pokud se tohle podcení, může se stát, že Vám nová role přeroste přes hlavu – a tým, který měl být motivovaný a soudržný, začne ztrácet energii nebo se rozpadat. Jak to tedy udělat, aby to fungovalo? Nejlepším způsobem je učit se od těch, kteří již nějakou dobu vedou týmy. O své zkušenosti se s námi podělili lídři ze společností</p>
<p>Albi, CREDITAS Group, DHL, PF komplet a snuggs.</p>
...
<blockquote>&quot;Jak se máš? &quot;. Kde začít? Vést tým není „vyšší level“ odbornosti, ale úplně nová disciplína. Právě tato obezřetnost a vědomí, že spokojenost není jednorázový cíl, ale běh na dlouhou trať, odlišuje zkušené lídry od těch začínajících. Zdá se Vám toho najednou hodně? Začněte jednoduše: naplánujte si 1:1 se svým týmem a ptejte se. Využijte k tomu Echo Pulse od Behavery - anonymní nástroj, který během pár minut zjistí, jak je váš tým spokojený, co potřebuje, co ho trápí a čeho si cení. Ihned vyhodnotí největší rizika a nabídne doporučení na míru, včetně konkrétních otázek pro vaše 1:1 .</blockquote>
`,
...
<p class="lead">“We must increase productivity! The only way to achieve that is by keeping employees close and watching them more closely. Let’s bring them back into the office!” - you may tell yourself, and expect a positive change. Worries with an office rent will vanish, that expensive equipment will no longer be unused, team collaboration will improve, communication will speed up, and everything will be great again.</p>
<p>Less than one-fifth of respondents in the HCI study said they rarely or never keep working hours when working from home. Half of employees handle personal matters during working hours, and 23 % take naps. These are certainly interesting numbers that might explain dips in productivity. But sincerely - will strict, office-only work help you? You likely have team members who prefer working from the office - they can’t focus well at home, they prefer to ask colleagues for information or opinions quickly, and the office buzz motivates them. But what works for one doesn’t necessarily work for another. And not everything that looks productive is actually productive. It’s easy to fall into the trap of “ productivity paranoia,” where a leader treats office presence and logged hours as the main productivity metrics instead of evaluating actual results and impact. Even a high performer can end up looking like a slacker in that scenario. Imagine you recognize someone from your team - or even yourself - among the following characters. Let’s see what’s on their minds…</p>
<h2>Let’s Take a Look Behind the Scenes</h2>
<p>“Why is Anna leaving? We spent months looking for someone as senior as she is, and we always praised her for responding even late at night. She was a results-focused model for everyone!” Anna, a senior developer, had adapted herself to the new digital nomad standard. She enjoyed working from anywhere - actually, this was even encouraged, especially for foreign clients. She helped improve the customer experience. A few times a year, she liked to pack up and spend at least a month somewhere abroad in a warmer climate. The new rule that forced her to stay in one place almost all the time and travel during vacation only made her realize she no longer doesn’t want to be part of it. She immediately started looking for new opportunities. In the meantime, she stopped joining initiatives and refused ad hoc requests. “Thomas has been more irritable lately… Something happened at home? I’m pretty sure, being in the office must be a relief for him…” Thomas an HR manager, went through a challenging time during COVID - he moved to a village outside Prague, renovated a house, and welcomed a new baby. Thanks to flexibility, he could help his wife at home and work on small house projects - made possible by avoiding long commutes and traffic jams. With the new rules, work became less enjoyable. He was expected to set an example from his position, so he should follow the 100% office presence. He might hold out a while longer, but he doesn’t want to see his children only when they’re asleep, so he started looking elsewhere. “Clara’s work has been slipping lately. We used to be excited about everything she delivered, but now it’s a different story. I also feel like she’s avoiding us…” Clara, a data analyst, is rather shy and prefers a quiet working environment. She likes working from home or remotely. She saw the new rule as a sign of a betrayal - as if trust and autonomy had disappeared. Even when she’s in the office, she’s almost invisible to others. On her way home, she browses job ads offering fully remote roles and shifts into a mindset of delivering the bare minimum.</p>
<p>COVID brought new insights, especially regarding working from home</p>
<ul>
<li>it’s possible in almost every industry or sector. People gradually began to see it as a desirable part of their work life, a way to better balance work and personal life, and to manage life as a whole, not as just their careers. What started as a benefit (and during the pandemic, a necessary evil)</li>
</ul>
<p>became an important part of the job offer, right next to salary.</p>
<p>This is confirmed by a survey from Hays: 52 % of respondents valued home office the most as a benefit, 32 % valued flexibility and free work scheduling. In the Czech Republic, 80 % of companies still offer home office to some extent, while only 30 % offer fully remote work (Pay-Fair survey 2025). If you want to remain an attractive employer and offer more than just a paycheck, it’s worth including and actively promoting home office as an option. Let people work in the way that suits them best—it really is possible to do so without losing productivity!</p>
...
<ul>
<li>helping you keep track of people you’re not in daily contact with and respond in time. This keeps you lead a diverse team that still functions as a unified whole. You’ll see whether new strategies resonate positively or negatively, and whether someone is close to burnout or to quit.</li>
</ul>
...
<p>👩🏽‍🦱 Ema (Customer Care) She once greeted every caller with warmth—now her tone is flat, rushed, and dismissive. She avoids helping, transfers calls, and has already called in sick three times this month.</p>
<p>👱🏻‍♂️ David (Software Developer) He used to bring fresh ideas and curiosity—now he keeps his camera off, contributes little, and submits buggy code others fix. When deadlines slip, he blames vague &quot;technical issues&quot; and logs off.</p>
<p>👨‍🦳 Lukas (Sales Leader) He once energized his team with strategy and coaching—now he’s distant, avoids CRM and calls, and blames the market for poor sales results. As his engagement fades, so does his team’s performance.</p>
<p>What do they have in common? They’re not underperforming due to incompetence. They’re disengaged. And they’re signaling it clearly—if anyone is looking. Disengagement often shows up as withdrawal, reduced initiative, rising absenteeism, or declining work quality. These signals are easily misread as laziness or attitude problems, when in fact they reflect a deeper issue:</p>
...
<ul>
<li>Listen to feedback and value opinions</li>
<li>Clarify expectations, roles, and responsibilities</li>
<li>Provide necessary resources and tools</li>
<li>Coach instead of control</li>
<li>Connect authentically</li>
<li>Genuinely care for their team’s well-being</li>
<li>Congratulate, celebrate, and recognize progress and success</li>
<li>Create opportunities for meaningful contribution</li>
</ul>
...
<ul>
<li>️  Regular, comparable, and objective insight focused on what truly matters</li>
<li>️  Fast touchpoints resulting in actionable and most impactful tips</li>
</ul>
...
<p>👩🏽‍🦱 Ema (Zákaznická podpora) Dříve každého volajícího srdečně přivítala - nyní je její tón plochý, a odpovídá uspěchaně a odmítavě. Vyhýbá se pomoci, přepojuje hovory a tento měsíc už třikrát volala, že je nemocná.</p>
<p>👱🏻‍♂️ David (Vývojář softwaru) I když pracuje z domu, přinášel neotřelé nápady a zajímal se o projekty - nyní má vypnutou kameru, do diskuzí se nezapojuje a odevzdává kódy s chybami, které po něm ostatní opravují. Když se termíny protahují, viní z toho &quot;technické problémy&quot; a raději se odhlásí.</p>
<p>👨‍🦳 Lukáš (Vedoucí prodeje) Měl schopnost nabíjet svůj tým energií díky jasné strategii a koučování - nyní je odtažitý, vyhýbá se CRM a telefonátům a ze špatných prodejních výsledků viní trh. Prodej stagnuje a co teprve výkonnost jeho týmu.</p>
<p>Co mají tihle lidé společného? Nejsou neschopní, jsou neangažovaní. A dávají to jasně najevo - pokud se někdo dívá. Neangažovanost se často projevuje jako uzavřenost, absence iniciativy, rostoucí absence nebo zhoršující se kvalita práce. Tyto signály jsou snadno zaměněny za lenost nebo „špatný přístup“, i když ve skutečnosti ukazují na hlubší problém – ztrátu smyslu a směru v práci a sounáležitosti s týmem a firmou. V některých případech tak pozorujeme &quot;quiet quitting&quot;. V horším případě jde o dokonce o vyhoření. A to není nic vzácného. Naopak. Můžeme se s tím setkat až znepokojivě často. Podle průzkumu Gallup 2024 je pouze 23 % zaměstnanců na celém světě aktivně zapojeno do své práce. Neuvěřitelných 62 % je neangažovaných a 15 % je aktivně neangažovaných. Pokud máte tedy tým o deseti lidech, statisticky vzato 6 z nich není plně angažovaných a minimálně u 1 hrozí vysoké riziko odchodu .</p>
<h2>Skrytá cena neangažovanosti</h2>
<p>Za neangažované zaměstnance se platí vysoká cena. Podle výzkumu Gallup 2024 stojí zaměstnavatele 34 % jejich ročního platu. A to bez započtení dalších dopadů: horší týmová atmosféra, nespokojení zákazníci, fluktuace a náklady na nábor a zaškolení – které se mohou vyšplhat až na dvojnásobek roční mzdy zaměstnance .</p>
<p>Navíc je u neangažovaných zaměstnanců o 43 % vyšší pravděpodobnost odchodu. A i ti, kteří zůstanou, mohou snížit produktivitu týmu až o 20 %. (Deloitte, Gallup) Neangažovanost jednoho člověka může vyvolat dominový efekt - zejména v úzce spolupracujících týmech nebo v prostředí pod vysokým tlakem. Tech firma zaměstnává vývojáře softwaru s platem 100 000 Kč měsíčně. V případě že bude neangažovaný v práci, přijde společnost o více než 400 000 Kč ročně, a to jen na ztrátě produktivity. Pokud zaměstnanec odejde, celkové náklady -včetně náboru a zaškolení mohou dosáhnout až</p>
<p><strong>2,4 mil. Kč</strong></p>
...
<li>Koučují místo kontrolování</li>
<li>Komunikují autenticky</li>
<li>Upřímně se zajímají o well-being svého týmu</li>
<li>Oceňují a oslavují a rozvoj a úspěch</li>
<li>Nabízí příležitosti k smysluplné práci</li>
</ul>
<p>Proč intuice nestačí Abyste však skutečně pochopili, kde se projevuje neangažovanost, a mohli s tím něco udělat, potřebujete víc než jen dobré návyky. Zejména pokud je váš tým velký, vzdálený nebo pod tlakem, varovné signály mohou snadno zůstat nepovšimnuty. A protože každý člověk má jiné potřeby a preference, univerzální řešení jednoduše nefungují. Každý člověk přináší jedinečné motivace, výzvy a styly práce, což znamená, že potřebujete:</p>
<ul>
<li>️ Pravidelné, srovnatelné a objektivní informace zaměřené na to, co je skutečně důležité.</li>
<li>️ Rychlé, akční tipy, které nezatěžují tým nekonečnými schůzkami a pokusy „co by mohlo fungovat“.</li>
</ul>
...
<p>—and the blame that follows, because as the hiring manager, the responsibility falls on you. But the problem isn’t your instincts—it’s the outdated and unreliable hiring methods that rely on gut feelings, intuition, and assumptions, forcing you to make decisions without solid data.</p>
...
`,
    content_cz: `
<p class="lead">Už je to tady zase - potřebujete nového obchodníka do svého týmu. Možná se vaše firma rozrůstá, nebo nahrazujete dalšího, který odešel. Probíráte se stohy naleštěných životopisů, vedete pohovory, kladete dobře připravené otázky a dokonce pořádáte zkušební dny. Pak najdete toho pravého - sebevědomý, charismatický, plný energie a s pevným stiskem ruky. Během prodeje na zkoušku Vás dokonce přesvědčil, abyste si koupili pero, které již vlastníte. Když se umí takhle dobře prodat, dokáže snad prodat cokoliv, ne? Měsíc na to - žádné uzavřené obchody, ztracení zákazníci, kteří se cítili ignorováni, a jednoho dne... se prostě vůbec neukáže. Co se pokazilo? Vždyť na pohovoru tak zazářil!</p>
<p>Pravda je, že skvělé pohovorové dovednosti neznamenají skvělé prodejní dovednosti. Sebevědomí během 30-ti minutové konverzace nepředpovídá výkon pod tlakem. Zkušební dny testují sehranost týmu, nikoli skutečné prodejní schopnosti. Komunikativní kandidáti zvládnou pohovory s lehkostí, ale to ještě neznamená, že umí uzavírat obchody. Hraní rolí pomáhá vyřadit slabé kandidáty, ale také ty, kteří prostě potřebují čas, aby nabyli sebedůvěry. Někteří z nejlepších obchodníků začínají pomalu, ale později předčí všechny. Berete si do týmu obchodníky jen na základě jejich vystupování? Pak se připravte na další špatnou volbu - a s ní i na odpovědnost, která padne na vaše bedra. Jako hiring manažer nesete důsledky, ale problém není ve vašem úsudku. Skutečná potíž spočívá v zastaralých a nespolehlivých metodách náboru, které zakládají rozhodování na intuici, dojmech a domněnkách místo na konkrétních datech.</p>
<p>Dobrá zpráva je, že to jde i chytřeji! Jak rozpoznat skutečný talent ještě před tím, než zavolá prvnímu zákazníkovi? Najímat někoho, kdo nesplňuje očekávání, není jen frustrující - je to nákladné. Podle studie společnosti Accenture stojí</p>
<p>průměrný prodejní výkon společnosti přibližně 3,2 % potenciálních příjmů.</p>
<p>Navíc náklady na odchod zaměstnance během prvního roku se mohou pohybovat od 30 % do 100 % jeho ročního platu. A jde to ještě dál. Každý špatný nábor má dopad na dynamiku týmu, morálku a produktivitu. I když si myslíte, že jste se z minulých chyb poučili, často se opakují. Proč? Vybírání špičkových obchodníků nemusí být tak obtížné. Klíčem k úspěchu je přestat se soustředit na povrchní gesta a okázalé chování a místo toho začít používat objektivní nástroje, měřit to, na čem skutečně záleží, a rozhodovat se na základě dat.</p>
<p>Přesně to přináší Behavera</p>
<ul>
<li>snadno použitelný nástroj měřící</li>
</ul>
...
<p>udržovat si motivaci i přes odmítnutí .</p>
...
<p>Samozřejmě, žádné dvě obchodní pozice nejsou úplně stejné. Ať už hledáte aktivní lovce, mistry vztahového prodeje nebo technické uzavírače obchodů – bez ohledu na to, zda společnost rychle roste nebo dolaďuje svůj produkt na trhu – vždy se objeví nějaké ty rozdíly. Nicméně tyto základní kompetence zůstávají klíčové ve všech situacích. Daří se Vám získat ty nejlepší obchodníky do týmu? Najít a udržet špičkové obchodníky by nemělo být pro Vás ani pro firmu takovou zátěží. Každý špatný nábor v obchodním oddělení stojí firmu tržby, zpomaluje růst a frustruje vedení i tým. Rozdíl mezi týmy, které se potýkají s problémy, a těmi vysoce výkonnými není ve štěstí - je to v identifikaci a investici do lidí se správným myšlením a kompetencemi od samého začátku . Behavera odstraňuje nejistotu při náboru zaměstnanců a poskytuje jasný, daty podložený přehled o tom, kdo bude ve Vaší organizaci a na dané pozici úspěšný. Díky našim herním simulacím a chatbotu se můžete přestat spoléhat na instinkty a</p>
<p>začít přijímat rozhodnutí, která skutečně ovlivní vaše výsledky . Umí Váš náborový proces skutečně vybrat ty nejlepší obchodní talenty? Pokud ne, je čas na změnu. Vyzkoušejte Behaveru ještě dnes a objevte skutečný potenciál svého týmu - a to zcela zdarma!</p>
<p>+420 724 256 447 hello@behavera.com</p>
`,
  ...
  /* ───────────────────────── 5 ───────────────────────── */
  {
    ...
    title_cz: 'Valxon na cestě od stížností na peníze k řešení skutečných problémů',
    slug: 'valxons-discovery-journey-of-the-truth-behind-money-complaints',
    excerpt: 'Change can be a catalyst for growth, but without structure, it can be a mess leading towards failure. When Valxon, a 15-employee and growing B2B company specializing in customized merchandise, underwent a leadership change, the new CEO, Karel Poplstein, was determined to support the team through ...',
...
`,
  ...
  {
    id: '7',
    title: 'How to do 1:1 meetings effectively: What works for experienced leaders',
    title_cz: 'Jak na 1:1 meetingy: Co funguje zkušeným team leaderům',
    slug: 'how-to-do-1-1-meetings-effectively',
    excerpt: 'For some leaders, 1:1 meetings are a popular part of their work, and other leaders struggle with how to grasp them properly. Whether you\'re a rookie or a veteran, we\'ve got practical tips from experienced leaders just for you. What works for them? Take a peek under the hood of their work with peo...',
    ...
    content: `
<p class="lead">Why do 1:1 meetings? There are leaders who may see them as wasted time not spent on &#x27;real work&#x27;. However, the opposite is true, 1:1s are one of the cornerstones to building trust and good relationships within a team.</p>
<p>They have a direct impact on engagement and loyalty because they make people feel that they are being heard and their concerns are respected. It&#x27;s also an opportunity to talk through obstacles, thereby increasing productivity.</p>
<p>Keeping your team happy and engaged is one of the main roles of a leader, which is why 1:1s are one of the best tools to achieve this.</p>
<blockquote>&quot;From a team leader&#x27;s perspective, I quite like these meetings, I enjoy them, I enjoy pushing people, pushing myself, and I enjoy seeing progress,&quot; revealed our very own Dušan Murčo . How often should you do 1:1s? It depends on the size of the team , the agenda , and whether you work in remote or office mode. &quot;Personally, I prefer a weekly structure because since we are not in the same office, I have time to see how people in the team are doing and what they are experiencing not only at work, but also outside of work. It helps me better understand the unspoken things—their personality and often the reasons behind their attitudes or decisions. So I definitely recommend it, especially in a remote environment,&quot; explained Eva Kianičková , Head of Customer Care in CEE, Websupport/Loopia. Jakub Žilinčan , VP of Global Marketing, Berlin Brands Group, spends 4-6 hours per week on 1:1 and uses different types of meetings depending on the agenda. &quot;Quantitatively and structured through monthly &#x27;team pulse checks&#x27;, qualitatively through unstructured 1:1 discussions and last but not least on occasional offsites where you can learn the most in a relaxed atmosphere.&quot; What should you talk about on 1:1s? The key is to have a clear agenda so that the meeting is productive and clear expectations are set. &quot;For me, 1:1s are about two basic things: feedback and people development . With new people I used to lead it, but after a while we got to a point where people were leading 1:1s a bit on their own—so they were better prepared for it and enjoyed it. When it has a clear agenda, they can take a whole month to get feedback on what they want to say and really prepare the notes ahead of time,&quot; recommends Dušan Murčo. However, at 1:1s, you don&#x27;t just have to deal with the workload, it&#x27;s an opportunity to get valuable feedback that leaders shouldn&#x27;t be afraid of. &quot;I would add not only feedback on the employee, but also interest in the employee&#x27;s feedback on the company, job description, tasks, and more. 1:1s seems like a great opportunity to possibly pick up on an employee&#x27;s dissatisfaction at a time when I can still do something about it. And a lot of leaders are simply afraid of feedback—because what if they find out the employee is unhappy. I agree with listening—we often have a tendency in 1:1s to whizz through the agenda in excel, check KPIs, and not care. But it should be the meeting where there is no one else on the team who is heard more or speaks up faster. And to be able to listen to my colleague, I need to be able to be silent,&quot; advises Barbora Malinovská , freelance coach, mentor, and trainer. Another important ingredient for good 1:1 meetings is a review of progress , both work and development. So what to focus on? &quot;Look at what was said at the last 1:1 and say what is the current state, where has it moved, what is the relevance, e.g. for meeting personal goals, what has changed, be fair. And a separate chapter is listening and clarifying (listening for understanding rather than reacting, even if we want to give useful feedback), giving space, not being afraid of silence, and then putting it on &#x27;paper&#x27;,&quot; adds Lenka Karlíková , Life &amp; Business Coach (ACC, ICF) and Trainer. What to avoid doing? Irregularity of meetings. Don&#x27;t do them when it suits you, because that will give people a sense of unreliability. On the other hand, we&#x27;re all only human, and there are situations where it doesn&#x27;t make sense to push the meeting to happen at all costs. &quot;I agree with the regularity and it&#x27;s an ideal top state, but (!) there are times when I really see that people would benefit from a bigger break in my time. Then we keep a weekly 1:1 on the calendar, but I send them out at that time to have coffee, go for a walk, read, play in the game room, just clear their head without the risk of someone filling that time with another problem to solve. Sometimes it&#x27;s more beneficial than being cajoled, but it really does take a good intervention when it&#x27;s needed. Not being afraid to break the rules (even my own) is a good leadership quality for me,&quot; Eva Kianičková revealed with honesty. In other words, have meetings planned in advance so that both parties can count on them. But don&#x27;t cancel unless absolutely necessary. Another thing to avoid is mental absence . If you are looking at your phone during a meeting, you are subconsciously letting the other party know that they are not important enough to you to give them your full attention . We live in an age of fragmented attention, notifications jump at us from left to right, and so the art of being present in the moment becomes a superpower . For leaders, this is especially true. &quot;Be &#x27;there&#x27;. Don&#x27;t do anything else while you&#x27;re doing it, don&#x27;t answer the phone, don&#x27;t do notifications, don&#x27;t multitask (especially if you have 1:1 as a remote call). Be there for your team member,&quot; adds Dušan Murčo. &quot;Just the signal that the phone is on the desk is bad. Change the environment—make those meetings outside the office. Go for a walk or go out for coffee/cake/etc.,&quot; adds Michal Dragan , Head Of Digital, Slovakia Travel. What to do with 1:1 outputs? What is written is given. &quot;Take notes and save them to disk so you can both refer back to them. If they show clear steps to take as a leader—work on them. Because if it goes to waste, people will stop liking 1:1s, and feel like there&#x27;s no point. You can start your next 1:1 meeting by reviewing what you talked about last time and where it led,&quot; recommends Dušan Murčo. If you have more senior people in your team, they are probably used to taking their own notes and organizing their work independently. However, they will need to know what the priorities are (for example, to follow the Eisenhower Principle or any of the other methods) and what the context of the tasks is in order to be able to work independently. Juniors and newbies need to be given more support without micromanaging them. In addition to the meeting notes, it will be nice to create specific assignments with tasks and guide them to be able to handle the tasks on their own like their more senior colleagues. What do you actually ask the team? Good questions are essential. Without them, the conversation may stall and you won&#x27;t get what&#x27;s on your agenda resolved. &quot;I would add topic areas. I always have a set of questions ready that track well-being , because that&#x27;s the bottom line for me on a 1:1. I ask them, if necessary to spark discussion, at every meeting. However, in addition to these, I also prepare topics for discussion that are driven by either the time of year, the current needs of the business, or significant changes,&quot; Igor Dudinsky , Chief Executive Officer, Enkon. We are preparing a practical assistant for leaders that will recommend quality questions for different situations. Think of it as the secret weapon of effective leaders. Want to be one of the first to try the assistant? Leave us an email and we&#x27;ll get back to you as soon as it&#x27;s ready. Behavera Assistant for Leaders Leaders, how do you do 1:1 meetings? Share your experiences with colleagues in the comments on LinkedIn and forward this article to colleagues because sharing is caring.</blockquote>
`,
    content_cz: `
<p class="lead">Proč dělat 1:1? Jsou leadeři, kteří je mohou vnímat jako promrhaný čas nestrávený “reálnou prací”. Avšak opak je pravdou, 1:1 jsou jeden ze základních pilířů na vybudování důvěry a dobrých vztahů v týmu.</p>
<p>Mají přímý vliv na angažovanost a loajalitu protože lidem dodají pocit, že jsou vyslyšeni a jejich zájmy jsou respektovány. Je to také příležitost probrat překážky, a tím zvyšují produktivitu.</p>
<p>Starat se o spokojenost a angažovanost vašeho týmu je jednou z hlavních rolí leadera, proto jsou 1:1 jeden z nejlepších nástrojů, jak toho docílit.</p>
<blockquote>„Z pohledu leadera týmu mám tyto schůzky docela rád, baví mě to, baví mě posouvat lidi, posouvat sebe a baví mě vidět pokrok,“ prozradil náš Dušan Murčo . Jak často dělat 1:1? To záleží na velikosti týmu , agendě a jestli fungujete v remote či office módu. „Mně osobně nejlépe vyhovuje týdenní struktura, protože jelikož nejsme ve stejné kanceláři, mám čas zjistit, jak se lidem v týmu daří a co prožívají nejen v práci, ale i mimo ni. Pomáhá mi to lépe pochopit nevyřčené věci – jejich osobnost a často i důvody jejich postojů nebo rozhodnutí. Takže to určitě doporučuji, zejména v remote prostředí,“ vysvětlila Eva Kianičková , Head of Customer Care in CEE, Websupport/Loopia. Jakub Žilinčan , VP of Global Marketing, Berlin Brands Group, se 1:1 věnuje 4-6 hodin týdně a používá různé typy schůzek podle agendy. „Kvantitativně a strukturovaně prostřednictvím měsíční &quot;pulse checks týmu&quot;, kvalitativně prostřednictvím nestrukturované diskuse 1:1 a v neposlední řadě na příležitostných offsitech, kde se můžete v uvolněné atmosféře naučit nejvíce.“ Co řešit na 1:1? Základem je mít jasnou agendu , aby byl meeting produktivní a byla nastavená jasná očekávání. „Pro mě je 1:1 o dvou základních věcech: o zpětné vazbě a rozvoji lidí . S novými lidmi jsem to vedl já, ale po nějaké době jsme se dostali do bodu, kdy lidé vedli 1:1 trochu sami – tak na to byli lépe připraveni a bavilo je to. Když to má jasný program, mohou si vzít celý měsíc na to, aby získali zpětnou vazbu o tom, co chtějí říct, a skutečně si připravit poznámky dopředu,“ doporučuje Dušan Murčo. Na 1:1 však nemusíte řešit jen náplň práce, je to příležitost pro získání cenného feedbacku, kterého by se leadeři neměli bát. „Já bych doplnila nejen feedback na zaměstnance, ale i zájem o jeho feedback na firmu, pracovní náplň, úkoly, a další. 1:1 mi připadá jako skvělá příležitost, jak případně podchytit nespokojenost zaměstnance v době, kdy s ní ještě můžu něco udělat. A spousta leaderů se feedbacku prostě bojí – protože co kdybych se dozvěděl, že je zaměstnanec nespokojený. Souhlasím s nasloucháním – často máme tendenci 1:1 prosvištět podle agendy v Excelu, checknout KPIs a nezajímat se. Ale mělo by to být právě tím setkáním, na kterém není nikdo jiný z týmu, který by byl slyšet víc nebo se přihlásil o slovo rychleji. A abych mohl/a kolegovi naslouchat, musím já umět mlčet,&quot; radí Barbora Malinovská , koučka, mentorka a školitelka na volné noze. Další důležitou ingrediencí dobrých 1:1 meetingů je zhodnocení pokroku , ať už pracovním, tak rozvojovým. Na co se tedy mrknout? „Podívat se na to, co zaznělo na posledním 1:1 a říct si, jaký je aktuální stav, kam se posunulo, jaký význam to má, např. pro naplnění osobních cílů, co se změnilo, být férový. A samostatnou kapitolou je naslouchání a vyjasňování (naslouchat pro porozumění než reagování, i pokud chceme dávat užitečnou zpětnou vazbu), dávat prostor, nebát se ticha a následně to dát na &quot;papír&quot;,” dodává koučingový pohled na 1:1 Lenka Karlíková , Life &amp; Business Coach (ACC, ICF) a Trainer. Čeho se vyvarovat? Nepravidelnost meetingů. Nedělejte je podle toho, kdy se vám to zrovna hodí, protože to dá lidem pocit nespolehlivosti. Na druhou stranu, všichni jsme jen lidi a jsou situace, kdy nedává smysl tlačit na pilu a za každou cenu trvat na tom, aby se meeting konal. „Souhlasím s pravidelností a je to ideální top stav, ale (!) jsou chvíle, kdy opravdu vidím, že by lidem v mém čase prospěla větší pauza. Pak necháváme v kalendáři týdenní 1:1, ale posílám je v tu dobu ven, aby si dali kávu, šli na procházku, četli si, hráli v herně, prostě si vyčistili hlavu bez rizika, že jim někdo ten čas vyplní dalším problémem k řešení. Někdy je to prospěšnější, než když mě přemlouvají, ale opravdu je třeba dobře zasáhnout, když je to potřeba. Nebát se porušovat pravidla (i ta vlastní) je pro mě dobrá leaderská vlastnost,“ s upřímností prozradila Eva Kianičková. Jinými slovy, meetingy mějte naplánované předem , ať s nimi obě strany mohou počítat. Ale nerušte je, pokud to není naprosto nezbytné. Další věcí, které je radno se vyvarovat, je duševní nepřítomnost . Pokud se během meetingu díváte do telefonu, nevědomky tím dáváte druhé straně najevo, že pro vás není dostatečně důležitá natolik, abyste jí věnovali svou plnou pozornost . Žijeme v době roztříštěné pozornosti, notifikace na nás skáčou zleva zprava, a tak se umění být přítomném okamžiku stává superschopností. Pro leadery toto platí dvojnásob. „Buďte &quot;tam&quot;. Nedělejte během toho nic jiného, nezvedejte telefon, nedělejte notifikace, nedělejte multitasking (zejména pokud máte 1:1 jako remote call). Buďte tam pro člena svého týmu,“ dodává Dušan Murčo. „Ono, už jen ten signál, že je telefon na stole, je špatný. Změňte prostředí – dělejte ty schůzky mimo kancelář. Jděte na procházku nebo vyběhněte někam na kávu/koláč/atd.,“ dodává Michal Dragan , Head Of Digital, Slovakia Travel. Co udělat s výstupy z 1:1? Co je psáno, to je dáno. „Dělejte si poznámky a uložte je na disk, abyste se k nim mohli oba vrátit. Pokud z nich vyplývají jasné kroky, které máte jako leader podniknout – pracujte na nich. Protože pokud to přijde nazmar, lidé přestanou mít rádi 1:1 a budou mít pocit, že to nemá smysl. Příští schůzku 1:1 můžete zahájit třeba tím, o čem jste mluvili minule a kam to vedlo,“ doporučuje Dušan Murčo. Pokud máte v týmu seniornější lidi, pravděpodobně jsou zvyklí si dělat vlastní poznámky a organizovat si práci samostatně . Budou však potřebovat vědět, co jsou priority (například následovat Eisenhowerův princip nebo kteroukoliv z dalších metod) a jaký je kontext daných úkolů, aby se dokázali samostatně pracovat. Juniorům a nováčkům je potřeba dát více podpory bez toho, abyste je mikromanagovali. Kromě poznámek z meetingu bude fajn vytvořit konkrétní úkoly se zadáním a vést je k tomu, aby byli schopni si úkoly zpracovávat sami jako jejich seniornější kolegové. Na co se vlastně týmu ptát? Dobré otázky jsou základ. Bez nich se může stát, že bude konverzace váznout a nevyřešíte to, co máte v agendě . „Ještě bych přidal tematické okruhy. Stále mám připravenou sadu otázek, které sledují well-being , protože to je pro mě to podstatné na 1:1. Kladu je, pokud je to potřeba k vyvolání diskuse, na každém setkání. Kromě nich si však připravuji i témata k diskusi, která se řídí buď ročním obdobím, aktuálními potřebami firmy, nebo významnými změnami,“ Igor Dudinský , Chief Executive Officer, Enkon. Připravujeme praktického asistenta pro leadery, který vám doporučí kvalitní otázky pro různé situace. Takovou tajnou zbraň efektivních leaderů. Chcete být jedni z prvních, co si asistenta vyzkouší? Nechte nám na sebe e-mail a my se vám ozveme jen, co bude hotový. Behavera assistent pro team leadery Leadeři, jak děláte 1:1 meetingy vy? Podělte se o své zkušenosti s kolegy v komentářích na LinkedInu a pošlete tento článek kolegům, protože sharing is caring.</blockquote>
`,
  ...
  /* ───────────────────────── 8 ───────────────────────── */
  {
    ...
    title_cz: 'Boříme 6 mýtů o well-beingu ve firmách',
    slug: 'busting-6-myths-about-well-being-in-companies',
    excerpt: 'Well-being has literally flooded the Internet this year, and this has not been without the spread of myths. Let\'s shine a light on some of the most widely spread myths between the doors of offices and workplaces. Whether it\'s the popularity of anonymous surveys, doing surveys only once a year, ad...',
    excerpt_cz: 'Well-being letos doslova zaplavil internety, a to se neobešlo bez šíření mýtů. Pojďme si posvítit na některé z těch nejvíce šířených mezi dveřmi kanclů i provozoven. Ať už to je obliba anonymních dotazníků, dělání průzkumů jen jednou ročně, řešení well-beingu příliš pozdě, obliba vlastních řešení...',
    content: `
<h2>1) Anonymous surveys are more honest and safe</h2>
<p class="lead">It depends on the company culture and whether the organization has a psychologically safe environment. If employees have the experience that anything they say will be used against them, then they may be reluctant to participate in surveys other than anonymously. Conversely, in companies where the culture is based on mutual trust, honesty, and cooperation, the need for anonymous surveys is almost non-existent. People are not afraid to share their opinions and want to be actively involved in the development of the company. The compromise is to give employees the choice of whether or not they want to disclose their names . Anonymous surveys have their limits. While you will find out what employees are concerned about, the opportunities to make changes will be limited. Some problems have universal solutions, but individual or team problems will be much harder to solve and require detective work. :) At Behavera, we believe that non-anonymous surveys are a better way to go. To be able to put its people first, a company needs to approach well-being solutions with openness and honesty. Feedback is a gift to be valued and goes hand in hand with a willingness to look at the problem from a different perspective. In the daily hustle and bustle, management may inadvertently overlook small issues that can build up over time. Feedback will help shine a light on these issues before they become serious problems. When an employee speaks up and discloses their name, you know who to go to for more information and learn a lot. You can include your people in problem-solving and the whole process helps build trust, strengthens relationships, and makes people feel heard and valued. Which is one of the key ingredients to happiness at work. Do you want to try the Behavera Well-being Index?</p>
<p>Sign up here .</p>
<h2>2) Doing a survey once a year is enough</h2>
<p>A year is a very long time and we live in a world where things change rapidly. If you do surveys once a year, you&#x27;ll know what the state of well-being is right now, but it won&#x27;t give you an evaluation of the whole year. Few of us remember how we felt a week, a month, or six months ago. Just try to remember what you were doing a year ago at this time. You should survey well-being ideally on a quarterly basis, and in the meantime do pulse checks (a few short questions instead of a long survey). You can then compare the data over time and notice patterns or more challenging periods. This way you can plan better and catch problems before they flare up into a critical situation. Flexibility, adaptability, and quick reactions are the cornerstones of today&#x27;s success. And this is much easier to do with data than without it.</p>
<p>On the other hand, surveys are not to be overdone or they will annoy people. Every company has different needs and it&#x27;s perfectly fine to try doing surveys every month in the beginning. Listen to your people and monitor your completion rates. Then set the frequency of surveys as it suits your needs.</p>
<h2>3) Well-being needs to be addressed only when there is a problem</h2>
<p>With well-being, it&#x27;s like preventive check-ups at the doctor. We all know we should go regularly, but we usually skip it until we have a serious problem. Prevention would save us a lot of time, money, and heartache, but we only take it seriously when it&#x27;s too late. It works the same way in companies, where well-being is only addressed when key people leave due to burnout and a tsunami of other problems arises. Starting to address well-being at this point may not save you from existing problems, but it will help you see early on where new ones may arise and prevent future problems. Companies often tell us that they will measure well-being when things calm down in the company. Sometimes they justify this because they don&#x27;t want to add another task to their people. Other times, they&#x27;re kind of afraid of what they&#x27;ll learn. Either way, measuring well-being only during quiet periods won&#x27;t give you true data that reflects reality. Addressing well-being as a problem prevention helps build more stable and stronger companies that can better overcome obstacles. In the long run, this also translates into people&#x27;s performance and effectiveness.</p>
<h2>4) Our own surveys are enough for us</h2>
<p>Surveys are a great start. People-first companies wanted to lend a helping hand to their people during the pandemic, and self-produced surveys were the most accessible option. This difficult task fell on the shoulders of HR professionals and leaders who tackled it as best they could. However, times have evolved and there are HR technologies on the market, such as Behavera, that combine insights from behavioral psychology with data science to take surveys to the next level. Why replace custom surveys with an HR platform? Surveys are a lot of work for little data. You will spend hours compiling surveys, chasing colleagues to complete them, and then analyzing the results. Which is expensive for companies and keeps HR professionals busy on tasks they may not enjoy or find fulfilling. Behavera does this work for you and you can spend your time focusing on helping people.</p>
<p>The quality of the outputs is directly correlated to the quality of the questions. In Behavera, all questions are carefully crafted by a team of behavioral scientists, so you don&#x27;t have to worry about how to word the questions correctly.</p>
<h2>5) Well-being is an individual problem, not a company problem</h2>
<p>Work plays a significant role in an individual&#x27;s well-being. In this sense, the company also contributes to the well-being of the individual. However, the role of the company is not to solve all the problems of individuals, but to create a safe environment and conditions such that the impact of work on well-being is positive. It is very important to respect everyone&#x27;s privacy. A company can be a platform where those who want to open up can do so. The least managers can do is to take a genuine interest in how their people are doing. Within their means, they can be accommodating to individuals in difficult times and provide them with support.</p>
...
<p>Great news, we&#x27;d like to introduce the Behavera Well-being Index, your people-first tool for a happier company. How does it all work? You&#x27;ll get an Echo chatbot that your team can talk to in 15 minutes to find out how much and in what areas people are calling for help. In the report, you&#x27;ll see up to 12 of the highest-risk areas, the overall score, and the completion rate. At the same time, for each risk area, you&#x27;ll get tips from behavioral psychologists on how to approach the problem. The Behavera Well-being Index will do the research for you, analyze the data, and advise you on how to manage it all. Do you address well-being in your company?</p>
<p>Let us know on LinkedIn and you will make us happy if you send the article to your colleagues.</p>
`,
    content_cz: `
<h2>1) Anonymní dotazníky jsou upřímnější a bezpečnější</h2>
<p class="lead">To záleží na firemní kultuře a jestli je v organizaci vybudované psychologicky bezpečné prostředí. Pokud mají zaměstnanci zkušenost, že cokoliv řeknou, bude použito proti nim, pak se mohou zdráhat se průzkumů účastnit jinak než anonymně. Naopak u firem, kde je kultura založená na vzájemné důvěře, upřímnosti a spolupráci, potřeba anonymních dotazníků téměř neexistuje. Lidé se nebojí sdílet své názory a chtějí se aktivně zapojovat do rozvoje firmy. Kompromisem je dát zaměstnancům volbu, jestli se chtějí nebo nechtějí podepsat. Anonymní dotazníky totiž mají své limity. Dozvíte se sice, co zaměstnance trápí, ale možnosti udělat změny budou omezené. Některé problémy mají plošná řešení, ale ty individuální či týmové půjdou vyřešit mnohem hůř a vyžadovat detektivní práci. :) V Behaveře věříme, že neanonymní dotazníky jsou lepší cesta. Aby byla firma schopná dát své lidi na první místo, potřebuje přistupovat k řešení well-beingu s otevřeností a upřímností. Feedback je dar, kterého je třeba si vážit a jde ruku v ruce s ochotou podívat se na problém z jiného úhlu pohledu. V každodenním shonu může vedení neúmyslně přehlížet drobné problémy, které se časem mohou nakupit. Feedback pomůže posvítit na tyto problémy ještě než se tak stane. Když na to poukáže zaměstnanec svým jménem, víte za kým přijít pro více informací a hodně se naučit. Můžete své lidi zahrnout do řešení problémů a celý proces pomáhá budování důvěry, utužuje vztahy a lidé se cítí vyslyšení a docenění. Což je jeden z hlavních předpokladů ke spokojenosti v práci. Chcete si vyzkoušet Behavera Well-being Index?</p>
<p>Zaregistrujte se zde .</p>
<h2>2) Dělat průzkum jednou ročně je dostatečné</h2>
<p>Rok je velmi dlouhá doba a žijeme ve světě, kde se věci rychle mění. Pokud děláte průzkumy jednou ročně, tak se dozvíte jaký je stav well-being právě teď, ale nevyhodnotí vám to celý rok. Jen málokdo z nás si pamatuje, jak se cítil týden, měsíc či půlrok dozadu. Schválně si vzpomeňte, co jste dělali před rokem touhle dobou. Je potřeba zkoumat well-being ideálně čtvrtletně a mezitím dělat tzv. pulse checks (pár krátkých otázek místo dlouhého průzkumu). Data za jednotlivá období si pak můžete porovnat a všímat si vzorců či náročnějších období. Dokážete tak lépe plánovat a hasit problémy ještě než vzplanou v kritickou situaci. Flexibilita, přizpůsobivost a rychlé reakce jsou základním kamenem úspěchu současnosti. A to se dělá mnohem snadněji s daty než bez nich.</p>
<p>Na druhou stranu se to s průzkumy nemá přehánět nebo se lidem zprotiví. Každá firma má jiné potřeby a je úplně v pořádku si na začátku vyzkoušet dělat průzkumy třeba i každý měsíc. Naslouchejte svým lidem a sledujte míru vyplnění. Četnost průzkumů si pak nastavte jak to vyhovuje vám.</p>
<h2>3) Well-being je potřeba začít řešit až když je problém</h2>
<p>S well-beingem je to jako s preventivními prohlídkami u lékaře. Všichni víme, že bychom na ně měli pravidelně chodit, ale většinou se na to vykašleme dokud nás nepotká nějaký závažný problém. Prevence by nám ušetřila spoustu času, peněz i trápení, ale bereme ji vážně až když je pozdě. Úplně stejně to funguje ve firmách, kde well-being řeší až ve chvíli, kdy jim kvůli vyhoření odejdou klíčoví lidé a strhne se tsunami dalších problémů.. Začít v tuto chvíli řešit well-being vám sice nezachrání existující problémy, ale pomůže vám včas vidět, kde mohou vzniknout nové a zabránit dalším problémům v budoucnosti. Firmy nám často říkají, že změří well-being, až se věci ve firmě trochu uklidní. Někdy to zdůvodňují tím, že nechtějí přidávat svým lidem další úkol. Jindy se tak trochu bojí toho, co se dozví. Každopádně měřit well-being jen v klidných obdobích vám nedá pravdivá data, která by odrážela realitu. Řešení well-beingu jako prevenci problémů pomáhá budovat stabilnější a silnější firmy, které dokážou lépe překonávat překážky. Dlouhodobě se to promítá i na výkonu a efektivitě lidí.</p>
<h2>4) Vlastní dotazník nám stačí</h2>
<p>Dotazníky jsou super začátek. People-first firmy chtěly během pandemie podat pomocnou ruku svým lidem a dotazníky vlastní výroby byly ta nejdostupnější volba. Tenhle těžký úkol pandul na bedra HR profesionálům a leaderům, kteří se s ním poprali jak nejlépe dovedli.</p>
<p>Doba však pokročila a na trhu existují HR technologie, jako například Behavera, které spojují poznatky behaviorální psychologie s datovou vědou a posouvají tak průzkumy na další level. Proč vyměnit vlastní dotazníky za HR platformu? Dotazníky jsou mnoho práce za málo dat. Čekají vás hodiny strávené sestavováním dotazníků, nahánění kolegů, aby je vyplnili a následně analýza výstupů. Což se firmám prodraží a HR profesionály vytěžuje na úkolech, které je nemusí bavit a naplňovat. Behavera tuhle práci udělá za vás a vy můžete věnovat svůj čas práci s lidmi.</p>
<p>‍Kvalita výstupů přímo souvisí s kvalitou otázek. V systému Behavera jsou všechny otázky pečlivě připraveny týmem behaviorálních vědců, takže se nemusíte starat o to, jak otázky správně formulovat.</p>
<h2>5) Well-being je to problém jednotlivce, a ne firmy</h2>
<p>Práce hraje jednu z významných rolí ve well-beingu jednotlivce. V tom smyslu se na well-beingu jednotlivce podílí i firma. Role firmy však není vyřešit všechny problémy jednotlivců, ale vytvořit bezpečné prostředí a takové podmínky, aby vliv práce na well-being byl pozitivní. Soukromí každého je velmi důležité respektovat. Firma může být platformou, kde ti, kteří chtějí se otevřít, tak mohou. To nejmenší, co manažeři mohou udělat je se upřímně se zajímat o to, jak se jejich lidem daří. V rámci svých možnosti mohou jednotlivcům vyjít vstříc v těžkých časech a poskytnout jim oporu.</p>
<h2>6) Well-being je stejný v celé firmě</h2>
<p>Opak je pravdou. Jsou jednotlivci, týmy nebo pobočky, kde se stav well-beingu může dramaticky lišit a je potřeba k nim přistupovat individuálně.</p>
<h2>Náš Well-being Index měří 12 nejvýznamnějších faktorů</h2>
<p>, které stojí za rizikem vyhoření, ztrátou engagementu, snížené produktivity a nebo rizikem odchodu. Dozvíte se tak, v jakých oblastech a jak moc lidé volají o pomoc. V přehledu zároveň vidíte, jak jsou na tom jednotlivé týmy či pobočky. Můžete tak snadno poznat, kde potřebují pomoc  a kde jsou věci v pořádku. Chtěli byste se do řešení well-beingu pořádně opřít?</p>
<p>Skvělá zpráva, rádi bychom vám představili Behavera Well-being Index, váš people-first nástroj pro spokojenější firmu. Jak to celé funguje? Získáte chatbota Echo, se kterým si váš tým během 15 minut popovídá a zjistí, jak moc a v jakých oblastech lidé volají o pomoc. V přehledu uvidíte až 12 nejrizikovějších oblastí, celkové skóre i míru vyplnění. Zároveň ke každé rizikové oblasti získáte tipy od behaviorálních psychologů, jak se k řešení problému postavit. Zároveň ke každé rizikové oblasti získáte tipy od behaviorálních psychologů, jak se k řešení problému postavit. Řešíte u vás ve firmě well-being?</p>
<p>Dejte nám vědět na LinkedInu a uděláte nám radost, když článek pošlete kolegům.</p>
`,
  ...
  {
    id: '9',
    title: 'The Well-being of Leaders at Risk: How to Take Care of Yourself and Become a Better Role Model',
    title_cz: 'Well-being leaderů v ohrožení: jak se o sebe postarat a stát se lepším vzorem',
    slug: 'well-being-of-leaders-at-risk',
    excerpt: 'In challenging times, we rely on our leaders as a lighthouse in the storm. What if they too run out of strength and their light goes out? This is what happens in many companies and it\'s time to make the well-being of leaders a priority. Are we ready for it and what pitfalls stand in our way? Let\'...',
    excerpt_cz: 'V těžkých časech se spoléháme na své leadery jako na maják v bouři. Co když i jim dojdou síly a zhasne jejich světlo? Právě to se v mnohých firmách děje a je na čase udělat well-being leaderů prioritou. Jsme na to připraveni a jaké nástrahy nám stojí v cestě? Pojďme si na to posvítit.',
    content: `
<p class="lead">Why is the well-being of leaders at risk?</p>
<p>The importance of well-being is finally dawning on executives and 89% [1] of c-level leaders have it as a priority. However, they themselves are not immune and the impact of the events of the last three years has taken its toll on them as well.</p>
<p>70% [1] of leaders are even considering changing jobs if they can find one that allows them a healthier lifestyle and more flexibility. They realize that in order to perform well in their role, well-being needs to start with themselves.</p>
<blockquote>&quot;We believe that when leaders take care of themselves, they are much more able to take care of their employees to be empathetic, creative, and inspiring. But when they&#x27;re depleted, running on empty and burnt out, it&#x27;s much harder to lead from what is best in them. Role modeling is key because we are changing an entire culture that used to believe that burnout is simply the price you pay for success,&quot; Arianna Huffington revealed in an interview with Forbes [2] . Changing priorities and making an effort to change are a great start and a significant step toward a healthier lifestyle. However, leaders recognize that navigating this new path will not be easy , and the main obstacle is the current way of working. The main villains are a high volume of work and a stressful agenda next to long hours. It is common for leaders not to take the vacation time needed to recover because of &quot;work that won&#x27;t wait&quot;. Will we be able to build a bridge across the gap between the need to address well-being and the reality of the workplace? Where there is a will, there is a way. Technology could be part of the solution . &quot;We believe that the time is coming when work will adapt to our lifestyle instead of adapting our lifestyle to work. This is a fundamental mindset shift that will require companies to take a different approach toward workers. Not only with the advent of applied AI, but it will also be more about changing the paradigm from &#x27;work hard&#x27; to &#x27;work smart&#x27;,&quot; predicts Tomáš Jiroušek, Investment Manager at MITON Group. How can leaders get started with well-being? &quot;We often refer to the phrase &#x27;work hard, play hard&#x27;, but this is the time when &#x27;rest well&#x27; deserves to be added. Find a sustainable model between stress and rest, because you also want to be a functional part of your team for as long as possible,&quot; recommends Behavera&#x27;s Dušan Murčo, who summarizes practical tips on leading people remotely in his Remote Leadership Manifesto. Working and leading people requires a lot of energy. Dušan recommends that leaders create routines that will help recharge your batteries during the workday. Whether it&#x27;s a phone call with loved ones, breathing exercises, a healthy snack, or whatever else works for you. Experiment and get to know yourself through it. Allow yourself to not drive yourself to the ground and forget about yourself. &quot;Don&#x27;t postpone it. Start and do it regularly, put it on your calendar, and focus on it,&quot; he added. In addition to routines and small habits, you can start working on changing your overall approach to work . If your calendar is quickly filled with work obligations, you don&#x27;t have the space to schedule quality time with family, sports, or time for deep work. You need to take the opposite approach and set boundaries. Prioritize time off for family and hobbies first on the calendar, block out time for sports activities, and finally time for uninterrupted deep work. Next, carve out time to dedicate only to your team and open the remaining capacity to other work responsibilities. It is the opposite approach to what many can even imagine. However, leaders who have changed their approach to work and their order of priorities are not as at risk of burnout and have better levels of well-being. How to take care of your team&#x27;s well-being? Now you know how to take care of yourself, let&#x27;s look at how to support your team. We recommend sticking to three principles: Have a genuine interest – regular team meetings, 1:1 meetings, and informal chats on Slack or Teams. In addition to face-to-face meetings, use well-being tools . &quot;Use intuition, but also use data,&quot; Dušan recommends. This is because you can uncover the reality that people are too afraid to talk about face-to-face early on. Research by Deloitte [1] revealed that only 56% of employees believe that leaders actually care about their well-being, while 91% of leaders think they care enough. This is why we need to do regular well-being surveys and base our decisions on data, not assumptions. Be present – be there for your people and be visible. Make it easy for your team to find you anytime, write to you, or call you further, Dušan recommends. Create a safe space – build trust through vulnerability. Show that it&#x27;s okay to make mistakes or feel bad. Be understanding, but also work to improve over the long term, advises Dušan. Companies with high levels of trust have 76% higher levels of engagement, 74% lower levels of stress, 56% higher levels of cooperation, 50% higher levels of productivity, and 27% lower levels of turnover [3] .</blockquote>
<p>How are you doing with your well-being at your team?</p>
<p>Try our free Well-being Index for the first 10 employees. You can send us questions and comments at hello@behavera.com.</p>
<h2>Sources:</h2>
<p>[1] Deloitte.com,</p>
...
<p>Vedení firem konečně začíná docházet důležitost well-beingu a 89 % [1] c-level leaderů ho má jako prioritu. Avšak ani oni sami nejsou imunní a vliv událostí posledních tří let se podepsal i na nich.</p>
<p>70 % [1] leaderů dokonce zvažuje změnu práce, pokud najdou takovou, která jim umožní zdravější životní styl a více flexibility. Uvědomují si, že aby mohli dobře zastávat svou roli, musí s well-beingem začít u sebe.</p>
<blockquote>„Věříme, že když se leadeři starají sami o sebe, jsou mnohem schopnější postarat se o své zaměstnance. Být empatičtí, kreativní a inspirativní. Když jsou však vyčerpaní a vyhořelí, je mnohem těžší ze sebe vydat to nejlepší a jít příkladem. Modelování rolí je klíčové, protože měníme celou kulturu, která si zvykla věřit, že vyhoření je prostě cena, kterou zaplatíte za úspěch,“ prozradila Arianna Huffington v rozhovoru pro Forbes [2] . Změna priorit a snaha o změnu jsou skvělý začátek a významný krok směrem ke zdravějšímu životnímu stylu. Avšak leadeři si uvědomují, že prošlapat tuto novou cestu nebude jednoduché a hlavní překážkou je současný způsob práce. Hlavními záporáky jsou velký objem práce a stresující pracovní náplň hned vedle dlouhé pracovní doby. Běžně se tak stává, že si leadeři nevybírají dovolenou potřebnou k regeneraci kvůli „práci, která nepočká“. Podaří se nám postavit most přes propast mezi potřebou řešit well-being a realitou v práci? Kde je vůle, tam je i cesta. Technologie by mohly být součástí řešení . „Věříme, že nastává doba, kdy se práce bude podřizovat našemu životnímu stylu, místo toho, abychom podřizovali svůj životní styl práci. Což je fundamentální změna mindsetu, která bude vyžadovat odlišný přístup firem směrem k pracovníkům. Nejen s nástupem aplikované AI to bude více o tom změnit paradigma z ‚pracuj tvrdě‘ na ‚pracuj chytře‘,“ předpovídá Tomáš Jiroušek, investiční manažer ve skupině MITON. Jak mohou leadeři začít s well-beingem? „Často sa opierame o frázu ‚work hard, play hard‘, ale práve táto doba si zaslúži pridať ‚rest well‘. Nájdite si udržateľný model medzi stress and rest, pretože aj vy chcete byť funkčná súčasť svojho teamu čo najdlhšie,“ doporučuje náš Dušan Murčo, který shrnul praktické tipy o vedení lidí na dálku ve svém Remote Leadership Manifesto . Práce a vedení lidí vyžaduje hodně energie. Dušan doporučuje, aby si leadeři vytvořili rutiny , které jim pomohou dobít baterky i během dne v práci. Ať už je to zavolání si s blízkými, dechové cvičení, zdravá svačinka, nebo cokoliv jiného, co vám vyhovuje. Experimentujte a skrze to poznejte sami sebe. Dovolte si nejet na dřeň a nezapomínat na sebe. „Neodsúvajte to. Začnite a robte to pravidelne, dajte si to do kalendára a sústreďte sa na to,“ dodal. Kromě rutin a drobných návyků můžete začít pracovat na změně celkového přístupu k práci . Pokud je váš kalendář rychle zaplněn pracovními povinnostmi, tak nemáte prostor plánovat kvalitní čas s rodinou, sport či čas na hlubokou práci. Je potřeba zaujmout opačný postoj a nastavit hranice. Jako první v kalendáři prioritizuje volno pro rodinu a koníčky, vyblokujte si čas na sportovní aktivity a nakonec čas na nerušenou hlubokou práci. Dále si vyhraďte čas, kdy se věnujete pouze svému týmu a zbývající kapacitu otevřete dalším pracovním povinnostem. Je to obrácený přístup, než jaký si mnozí dovedou byť jen představit. Avšak leadeři, kteří změnili svůj přístup k práci i pořadí priorit nejsou tolik ohroženi vyhořením a mají lepší úroveň well-beingu. Jak se postarat o well-being svého týmu? Teď už víte, jak se starat o sebe, tak se pojďme podívat ještě na to, jak podpořit svůj tým. Doporučujeme držet se tří principů: Upřímně se zajímejte – pravidelná setkání týmu, 1:1 schůzky i neformální pokec na Slacku nebo Teamsech. Kromě osobních schůzek využívejte i nástroje na well-being . „Použijte intuici, ale taky použijte data,“ doporučuje Dušan. Můžete totiž včas odhalit realitu, o které se lidé bojí mluvit tváří v tvář. Průzkum společnosti Deloitte [1] odhalil, že pouhých 56 % zaměstnanců věří, že se o jejich well-being leadeři skutečně zajímají, zatímco 91 % leaderů si myslí, že se zajímají dostatečně. Právě proto je potřeba dělat pravidelné průzkumy well-beingu a opírat svá rozhodnutí o data, ne o domněnky. Buďte přítomni – buďte tu pro své lidi a buďte vidět. Udělejte pro svůj tým jednoduché vás kdykoliv najít, napsat vám či zavolat dále doporučuje Dušan. Vytvořte bezpečný prostor – budujte důvěru skrze zranitelnost. Ukažte, že je v pořádku dělat chyby, nebo se cítit špatně. Mějte pro to pochopení, ale také dlouhodobě pracujte na zlepšení, radí Dušan. Ve firmách, kde je je vysoká hladina důvěry je o 76 % vyšší angažovanost, o 74 % nižší stres, o 56 % vyšší míra ochoty spolupracovat, o 50 % vyšší produktivita a o 27 % nižší míra fluktuace. [3].</blockquote>
<p>Jak jste na tom s well-beingem vy?</p>
<p>Vyzkoušejte náš Well-being Index zdarma pro prvních 10 zaměstnanců. Dotazy a připomínky nám můžete zaslat na hello(at)behavera.com.</p>
<h2>Zdroje:</h2>
<p>[1] Deloitte.com,</p>
<h2>The C-suite&#x27;s role in well-being</h2>
<p>, autoři Steve Hatfield, Jen Fisher a Paul H. Silverglate [2] Forbes.com, Arianna Huffington: Putting Empathy Into Action Yet Again, autor Dan Pontefract [3] Hbr.org, The Neuroscience of Trust, autor Paul J. Zak</p>
`,
  ...
  {
    id: '10',
    title: 'HR Conferences 2023: an overview of international online events',
    title_cz: 'HR konference 2023: přehled zahraničních akcí s možností virtuální účasti',
    slug: 'hr-conferences-2023-international-online-events',
    excerpt: 'Would you like to go abroad for inspiration, but you don\'t have the cash for a big trip right now? No worries, a number of international conferences offer the option of virtual attendance in Europe-friendly times, and some are even free of charge. Choose from our list, get your notepads ready, an...',
    excerpt_cz: 'Rádi byste si odskočili pro inspiraci do zahraničí, ale na velké cestování teď nemáte chechtáky? Nevadí, celá řada zahraničních konferenci nabízí možnost virtuální účasti a některé jsou dokonce zdarma. Vyberte si z našeho seznamu, oprašte angličtinu a užijte si přednášky i diskuze z pohodlí domova.',
    content: `
<p>HRD Collective Europe</p>
<p class="lead">How do the world&#x27;s experts view the current challenges in HR? And what solutions do they offer? We can look forward to speakers from companies such as Patagonia, Bank of Ireland, Wella, Udemy Business, Britvic, and others. The event is free to attend and the program will take a nice broad look at topics that are on the minds of perhaps every HR professional.</p>
<p>When: 28 February 2023 Where: Online Website:</p>
<p>hrdcollective.org/europe FORWARD 2023 The global conference from Hacking HR boldly claims to be the most important HR event in the world. They&#x27;ve invited the biggest thought leaders to share insights, data, stories, knowledge, and more. Sounds like quite a ride, see you there?</p>
<p>When: 6-9 March 2023 Where: Online Website:</p>
<p>hackinghrlab.io HR and Future of Work Technology is a catalyst for huge changes in business and the way we work. The HR Exchange Network hosts several events throughout the year and they are free. This one focuses on the future of work and you will learn about topics such as upskilling, benefits relevant to the current times, metaverse, employee data, and how to ensure engagement in the future.</p>
<p>When: 14-16 March 2023 Where: Online Website:</p>
<p>hrexchangenetwork.com The Future of Diversity, Equity, Inclusion, and Belonging Do you want to focus on diversity, equal opportunities, and inclusion in the workplace this year? Then this free online event is for you. According to the organizers, this is a topic that many HR professionals struggle with, even though the situation is improving on all fronts. Why is it and what do your colleagues abroad have to say about it? Find out at the HR.com event.</p>
<p>When: 15-16 March 2023 Where: Online Website:</p>
<p>hr.com Reduce Turnover, Enhance Productivity &amp; Satisfaction Through Culture, Flexibility &amp; Development Did you know that companies with engaged employees have 23% higher profits? Low engagement is an issue that affects more than one organization. At the free online event, you can get inspiration on building company culture, flexible working, personalizing employee development, and improving communication.</p>
<p>When: 25-26 April 2023 Where: Online Website:</p>
<p>hrexchangenetwork.com CHRO Summit: The Path Forward Forget lectures, the CHRO Summit concept is built on conversation. The organizers invited well-known CHROs to discuss topics that are the daily bread of HR leaders. So jump in for a bite of inspiration for yourself.</p>
<p>When: 26 April 2023 Where: Online Website:</p>
<p>conference-board.org</p>
<h2>HRD Collective North America</h2>
<p>This conference promises to be not just lectures, but discussions and panels where</p>
<p>senior HR professionals exchange experiences. Last year&#x27;s edition welcomed guests from companies like Microsoft, Twitter, New Balance, Firelli, L&#x27;Oreal, Boeing, Volvo, Citi, Warner Bros, and more. We believe that we are expecting a packed guest list this year as well.</p>
<p>When: 17 May 2023 Where: Online Website:</p>
<p>hrdcollective.org/northamerica</p>
<h2>HR and the Future of Work EMEA</h2>
<p>The 4-day work week is forcing us to rethink productivity and the employee experience is becoming the number one priority. This interactive online event will focus on the future of work and learn about topics such as hybrid working, using AI and automation as a solution to employee work overload, diversity and building a talent network within the business.</p>
<p>When: 30-31 May 2023 Where: Online Website:</p>
<p>hrexchangenetwork.com Support Workplace Well-being &amp; Employee Engagement Because we all need a little help right now. An online event beckons to reveal strategies that work. You&#x27;ll learn how to build mental health support programs that solve real problems. How to relieve stress in the workplace, manage anxiety, create a culture focused on well-being, and how to make the business case.</p>
<p>When: 21 June 2023 Where: Online Website:</p>
<p>hci.org</p>
...
`,
    content_cz: `
<p>HRD Collective Europe</p>
<p class="lead">Jak se světoví experti staví k momentálním výzvám v HR? A jaká řešení nabízí? Těšit se můžeme na speakery z firem jako je Patagonia, Bank of Ireland, Wella, Udemy Business, Britvic a další. Akce je zdarma a program se hezky zeširoka zaměří na témata, kterými si láme hlavu snad každý HR profesionál.</p>
<p>Kdy: 28. února 2023 Kde: Online Web:</p>
<p>hrdcollective.org/europe FORWARD 2023 Globální konference z dílny Hacking HR odvážně tvrdí, že se jedná o tu nejdůležitější HR akci na světě. Pozvali ty největší thought leadery, kteří se podělí o insighty, data, příběhy, znalosti a další. To vypadá jako pořádá jízda, vidíme se tam?</p>
<p>Kdy: 6. – 9. března 2023 Kde: Online Web:</p>
...
<p>hrexchangenetwork.com CHRO Summit: The Path Forward Zapomeňte na přednášky, koncept CHRO Summitu je postaven na konverzaci. Organizátoři pozvali známé CHRO, aby se prodiskutovali témata, která jsou denním chlebem HR leaderů. Tak si skočte ukousnout trochu inspirace i pro sebe.</p>
<p>Kdy: 26. dubna 2023 Kde: Online Web:</p>
<p>conference-board.org</p>
<h2>HRD Collective North America</h2>
<p>Tahle konference slibuje, že se nejedná čistě o přednášky, ale o diskuze a panely, kde si</p>
<p>seniorní HR profesionálové vyměňují zkušenosti. Loňský ročník přivítal hosty z firem jako je Microsoft, Twitter, New Balance, Firelli, L&#x27;Oreal, Boeing, Volvo, Citi, Warner Bros a další. Věříme, že i letos nás čeká nadupaný seznam hostů.</p>
<p>Kdy: 17. května 2023 Kde: Online Web:</p>
<p>hrdcollective.org/northamerica</p>
<h2>HR and the Future of Work EMEA</h2>
<p>4 denní pracovní týden nás nutí přehodnotit produktivitu a zaměstnanecký zážitek se stává prioritou číslo jedna. Interaktivní online event se zaměří na téma budoucnosti práce a dozvíte se například o hybridní práci, využití AI a automatizace jako řešení na přetížení zaměstnanců, diverzita a budování talentové sítě v rámci firmy.</p>
<p>Kdy: 30. – 31. května 2023 Kde: Online Web:</p>
<p>hrexchangenetwork.com Support Workplace Well-being &amp; Employee Engagement Protože všichni teď potřebujeme trochu podpory. Online event láká na odhalení strategií, která fungují. Dozvíte se, jak vybudovat programy pro podporu mentálního zdraví, které řeší opravdové problémy. Jak zmírnit stres na pracovišti, poradit si s úzkostmi, vytvořit kulturu zaměřenou na well-being a jak si to obhájit z byznysového hlediska.</p>
<p>Kdy: 21. června 2023 Kde: Online Web:</p>
<p>hci.org</p>
<h2>Creating an Inclusive Work Culture</h2>
...
`,
  ...
  {
    id: '11',
    title: 'HR Conferences 2023: overview of the best events in the Czech Republic and Slovakia',
    title_cz: 'HR konference 2023: přehled nejlepších akcí v ČR a na Slovensku',
    slug: 'hr-conferences-2023-czechia-and-slovakia',
    excerpt: 'Where to go this year to get educated and inspired? We\'ve put together a list of top events for HR professionals, leaders, and technology enthusiasts. The topics of this year\'s conferences are really diverse, so we believe everyone will find their favorites.',
    excerpt_cz: 'Kam letos vyrazit se nachytřit a inspirovat? Připravili jsme pro vás seznam top akcí pro HR profesionály, leadery a nadšence do technologií. Témata letošních konferencí jsou opravdu rozmanitá, tak věříme, že si každý najde své favority.',
    content: `
<p class="lead">Learn &amp; Tech (HR Forum)</p>
<p>Want to find out where the L&amp;D technology market has evolved? Come to Bratislava to try out the latest gadgets that help companies take employee training to a whole new level. In addition, you can expect discussions with experts and networking at the end.</p>
<p>When: 23. 3. 2023, 13:00 – 18:00 Where: Bratislava Website:</p>
<p>firemnivzdelavani.eu Fenomén</p>
<h2>The fourth edition of the conference in Zlín will be about</h2>
<p>the transformation of traditional business into the business of the digital age. It is a very broad topic and the organizers promise that the business owner, manager, production engineer, IT worker, HR professional, or even freelancers will find something to their liking. There are four stages with thirty speakers, a panel discussion, and an additional program, so there&#x27;s something for everyone.</p>
<p>When: 23. 3. 2023, 8:00 – 22:00 Where: Zlín Website:</p>
<p>konferencefenomen.cz HR (R)Evoluce</p>
<h2>Employee values and preferences</h2>
<p>have changed dramatically in recent years. How can companies keep up with them and collectively weather the economic slowdown? And what role does</p>
<p>digitalization and automation play in these changes?</p>
<p>When: 13. 4. 2023, 9:00 – 17:00 Where: Prague Website:</p>
<p>tuesday.cz Performia</p>
<h2>Are you looking for ways to improve the</h2>
<p>education and communication skills of your people? Are you interested in how to get them more excited, motivated, and accountable? The Performia conference will focus on exactly these areas in this year&#x27;s event.</p>
<p>When: 17. – 18. 5. 2023, 9:00 – 18:00 Where: Prague Website:</p>
<p>performia.cz HR Know How Are you interested in new ways of working and leading people? Companies are facing economic pressures and this has an impact on HR, which must be prepared to actively influence the business. The conference focuses thematically on the areas of personalisation, agile leadership, flexibility, digitalisation, DEI (Diversity Equity Inclusion), and sustainability.</p>
<p>When: 18. 5. 2023, 9:00 – 18:00 Where: Prague Website:</p>
<p>hrforum.cz HR Congress The world is changing fast and so are best practices. What to focus on this year and how to get it right? This is what the HR Congress from the Association of HR Professionals of the Czech Republic promises to reveal.</p>
<p>When: 23. 5. 2023, 9:00 – 13:30 Where: Prague Website:</p>
<p>svazpersonalistu.cz Talent Acquisition and People Analytics Do you like international conferences where you can learn something interesting about recruitment and people data? The organizers will soon reveal the topics of the lectures and which speakers will share their know-how this year.</p>
<p>When: 6. – 7. 9. 2023 Where: Prague Website:</p>
<p>waset.org Human Brand Save the date in your calendars, you don&#x27;t want to miss this popular conference focused on employer branding. The theme of this year&#x27;s event is</p>
<h2>When Culture Drives Business</h2>
<p>and you can look forward to speakers like Magdaléna Wavle (Vodafone), Marta Slováková (TOI TOI &amp; DIXI, Slovakia), Miroslava Nebuželská (22HLAV), Gabriela Končitíková (Tomáš Bat&#x27;a Foundation), Jiří Mach (Enehano Solutions) and Jan Korda (Smysluplná škola).</p>
<p>When: 5. 10. 2023 Where: Prague Website:</p>
<p>humanbrand.cz HRko What happens in Ostrava stays in Ostrava. Preparations for the HR party and festival in one are in full swing and the program looks really great. Who can you look forward to? For example, Jiří Havel (Notino), Petr Novotný (Rohlík Group), Tomáš Ervín Dombrovský (LMC), Petra Hořejší (ASB CR), Libuše Máchová (Kooperativa), Marek Novák (Allianz) and many others. And if that&#x27;s not enough, you can arrive a day earlier for the before party.</p>
<p>When: 12. 10. 2023 Where: Ostrava Website:</p>
<p>hrko.cz Happiness@Work The theme of this year&#x27;s conference is Happiness and Leadership. Apparently, even if it doesn&#x27;t seem like it, happiness at work is primarily a leadership topic because where people feel good, they perform better and the company ultimately thrives better.</p>
<p>When: 19. 10. 2023 Where: Prague Website:</p>
<p>happinessatwork.live Evolve Evolve runs to the finish line with the relay baton, the popular Brno event concludes this year&#x27;s conference run. Speakers and program preparations are said to be in full swing, so at least save the date in your calendar and we&#x27;ll see you in Brno.</p>
<p>When: 2. 11. 2023 Where: Brno Website:</p>
<p>evolvesummit.cz Have we forgotten an event that should definitely be on this list? Email us at marketing(at)behavera.com and we&#x27;ll add it.</p>
`,
    content_cz: `
<p class="lead">Learn &amp; Tech (HR Forum)</p>
<p>Chcete zjistit, kam se posunul trh s technologiemi pro L&amp;D? Zajeďte si do Bratislavy vyzkoušet nejnovější vychytávky, které firmám pomáhají posunout vzdělávání zaměstnanců na úplně jiný level. Kromě toho na vás čekají diskuze s odborníky a závěrem i networking.</p>
<p>Kdy: 23. 3. 2023, 13:00 – 18:00 hod.</p>
<p>Kde: Bratislava Web:</p>
<p>firemnivzdelavani.eu Fenomén</p>
<h2>Čtvrtý ročník zlínské konference bude</h2>
<p>o transformaci tradičního podnikání na byznys digitálního věku. Je to velmi široké téma a organizátoři slibují, že si na své přijde majitel firmy, manažer, výrobní inženýr, IT pracovník, HR profesionál nebo i freelanceři. Čekají na vás čtyři stage, na kterých se vystřídá třicet přednášejících, panelová diskuze a doprovodný program, tak si každý najde to své.</p>
<p>Kdy: 23. 3. 2023, 8:00 – 22:00 hod.</p>
<p>Kde: Zlín Web:</p>
<p>konferencefenomen.cz HR (R)Evoluce</p>
<h2>Hodnoty a preference zaměstnanců</h2>
<p>se v posledních letech dramaticky změnily. Jak s nimi mohou firmy udržet krok, aby si je udrželi a společně přečkali období ekonomického zpomalení? A jakou roli v těchto změnách hraje digitalizace a automatizace?</p>
<p>Kdy: 13. 4. 2023, 9:00 – 17:00 hod.</p>
<p>Kde: Praha Web:</p>
<p>tuesday.cz Performia</p>
<h2>Hledáte cesty, jak vylepšit</h2>
<p>vzdělání a komunikační dovednosti svých lidí? Zajímá vás, jak je více nadchnout, motivovat a dát jim větší zodpovědnost? Konference Performia se přesně na tyto oblasti zaměří v letošním ročníku.</p>
<p>Kdy: 17. – 18. 5. 2023, 9:00 – 18:00 hod.</p>
<p>Kde: Praha Web:</p>
<p>performia.cz HR Know How Zajímáte se o nové způsoby práce a vedení lidí? Firmy čelí ekonomickým tlakům a to má svůj vliv i na HR, které musí být připraveno aktivně ovlivňovat byznys. Konference se tematicky zaměřuje na oblasti personalizace, agilního leadershipu, flexibility, digitalizace, DEI (Diversity Equity Inclusion) a udržitelnosti.</p>
<p>Kdy: 18. 5. 2023, 9:00 – 18:00 hod.</p>
<p>Kde: Praha Web:</p>
<p>hrforum.cz HR Congress Svět se rychle mění a s ním i best practices. Na co se letos zaměřit a jak to správně uchopit? To slibuje prozradit HR Congress od Svazu personalistů ČR.</p>
<p>Kdy: 23. 5. 2023, 9:00 – 13:30 hod.</p>
<p>Kde: Praha Web:</p>
<p>svazpersonalistu.cz Talent Acquisition and People Analytics Máte rádi mezinárodní konference, kde se dozvíte něco zajímavého o náboru a people datech? Organizátoři už brzy prozradí témata přednášek a jací řečníci se letos podělí o své know-how.</p>
<p>Kdy: 6. – 7. 9. 2023 Kde: Praha Web:</p>
<p>waset.org Human Brand Zakroužkujte si datum v kalendářích, tuto HRisty oblíbenou konferenci zaměřenou na employer branding letos nechcete propásnout. Tématem letošního ročníku je</p>
<h2>Když kultura pohání byznys</h2>
<p>a těšit se můžete na řečníky, jako jsou Magdaléna Wavle (Vodafone), Marta Slováková (TOI TOI &amp; DIXI, Slovensko), Miroslava Nebuželská (22HLAV), Gabriela Končitíková (Nadace Tomáše Bati), Jiří Mach (Enehano Solutions) a Jan Korda (Smysluplná škola).</p>
<p>Kdy: 5. 10. 2023 Kde: Praha Web:</p>
<p>humanbrand.cz HRko Co se stane v Ostravě, zůstane v Ostravě. Přípravy na HR party a festival v jednom jsou v plném proudu a program vypadá opravdu skvěle. Na koho se můžete těšit? Například na Jiřího Havla (Notino), Petra Novotného (Rohlík Group), Tomáše Ervína Dombrovského (LMC), Petru Hořejší (ASB ČR), Libuši Máchovou (Kooperativa), Marka Nováka (Allianz) a mnoho dalších. A pokud vám to nestačí, můžete dorazit o den dříve na “before party”.</p>
<p>Kdy: 12. 10. 2023 Kde: Ostrava Web:</p>
<p>hrko.cz Happiness@Work Tématem letošní konference je Štěstí a Leadership. Prý i když se to nezdá, tak štěstí v práci je především leadership téma, protože kde se lidé cítí dobře, podávají lepší výkony a firmě se ve výsledku lépe daří.</p>
<p>Kdy: 19. 10. 2023 Kde: Praha Web:</p>
<p>happinessatwork.live Evolve Se štafetovým kolíkem do finiše dobíhá Evolve, populární brněnská akce uzavírá letošní běh konferencí. Domlouvání řečníků a příprava programu je už prý v plném proudu, tak si alespoň poznačte datum v kalendáři a uvidíme se v Brně.</p>
<p>Kdy: 2. 11. 2023 Kde: Brno Web:</p>
<p>evolvesummit.cz Zapomněli jsme na některou akci, která by na tomto seznamu rozhodně neměla chybět? Napište nám na marketing(at)behavera.com a my ji přidáme.</p>
`,
  ...
  {
    id: '12',
    title: 'Behavera Well-being Index: modern happiness survey and practical recommendations all in one',
    title_cz: 'Behavera Well-being Index: moderní průzkum spokojenosti a praktická doporučení v jednom',
    slug: 'behavera-well-being-index',
    excerpt: 'What if there was a tool that could do the research for you, analyze the data and recommend how to improve well-being in your company? Forget boring surveys and hours spent evaluating the results. With the Well-being Index, you can focus on taking care of your people and keeping them happy at work.',
...
<p>Sign up here for free . Where do companies most often waste money?</p>
<p>Well-being, burnout, and mental health tend to be perceived as personal problems. Therefore, companies often address it by offering wellness programs or educational workshops.</p>
...
`,
    content_cz: `
<p class="lead">Well-beingu lze dosáhnout, když jsme</p>
<p>celkově spokojení se svým životem po osobní i profesní stránce. Je to stav, který je neustále proměnný a můžeme ho ovlivnit pomocí naučitelných dovedností podobně jako třeba pracujeme na svých měkkých dovednostech.</p>
<p>Firmy by měly považovat well-being za hmatatelnou dovednost, kritický přínos pro podnikání a měřitelný výsledek. Je důležité, aby si leadeři vážili well-beingu svých lidí stejně jako si váží jejich dovedností. Dva roky pandemie dolehly na každého z nás a mají přímý vliv na produktivitu v práci. Podle průzkumu</p>
<p>[2] zaměstnavatelé investovali do wellness benefitů a aktivit, aby svým zaměstnancům podali pomocnou ruku. Avšak zaměstnanci reportovali, že jejich zdrojem vyhoření je neustálá dostupnost kvůli špatnému používání technologií, nedostatek flexibility a autonomie, nebo neudržitelně velké množství práce. Problém tedy spočívá v uchopení problematiky well-beingu za špatný konec ze strany zaměstnavatelů. Chcete si vyzkoušet Behavera Well-being Index?</p>
<p>Zaregistrujte se zdarma zde . Kde firmám nejčastěji tečou peníze?</p>
<p>Well-being, vyhoření a mentální zdraví bývají vnímané jako problém jednotlivce. Proto ho firmy často řeší nabídkou wellness programů nebo vzdělávacích workshopů.</p>
...
<h2>Zdroje:</h2>
<p>[1]+[5] Weforum.org, The priority for workplaces in the new normal? Wellbeing, autor Liz Hilton Segel [2] Mckinsey.com, McKinsey Health Institute (MHI) global survey [3]+[4] Weforum.org, Addressing employee burnout: Are you solving the right problem?</p>
<p>, autor Jacqueline Brassey [5] Weforum.org, Restoring employee wellbeing for the new world of work, autor Marie Puybaraud</p>
`,
  ...
  {
    id: '14',
    title: '7 tips for improving employee engagement in a hybrid work model',
    title_cz: '7 tipů pro zlepšení angažovanosti zaměstnanců v hybridním modelu práce',
    slug: '7-tips-for-improving-employee-engagement-in-hybrid-work',
    excerpt: 'Did employee engagement give you wrinkles before the pandemic? In a hybrid setting, this poses an even greater challenge for many companies. If you don\'t know where to start or are running out of inspiration on what else to try, perhaps you\'ll find our practical tips useful.',
...
<p>A job well done is a given, but mistakes are the end of the world? That approach is outdated.</p>
<p>Praise and recognition for successful projects have a great impact on the psychological well-being and sense of fulfillment of employees.</p>
<p>According to a study, up to 66% [1] of people would quit their jobs if they felt unappreciated. For younger generations, this figure rises to 76%. Managers with a tough-love approach can cost a company a fortune and it pays to switch to a people-first approach.</p>
<h2>6) Establish work-life balance as a company value</h2>
<p>The biggest challenge of working in remote mode is disconnecting from work. When employees commute to the office, the journey to and from work is a rite of passage between home and work. The home office has eliminated this long-cultivated habit, and the result is burnt-out employees (along with trends like The Great Resignation and Quiet Quitting).</p>
<p>During the pandemic, it became apparent that simply closing a laptop at the end of the day in the home office environment wasn&#x27;t enough to mentally disconnect from work. People often check email and Slack on their mobile phones, thinking that &#x27;just in case&#x27; someone was looking for them. However, the lack of continuous availability is a result of a lack of communication of expectations. And if messages from the boss are coming in at 10 pm, then he&#x27;s not exactly setting a good example. A healthy work-life balance contributes to employee well-being, and satisfaction leads to greater engagement.</p>
<h2>7) Give people a chance to grow</h2>
<p>Employees become disengaged when work becomes a boring routine that is unfulfilling and lacks opportunities to grow. Company training is often seen as a cost instead of an investment. It tends to be one of the first things budgets are cut. This move comes back like a boomerang to companies in the form of unhappy, disengaged employees, and even frequent resignations [2].</p>
...
`,
    content_cz: `
<h2>1) Mluvte spolu často a smysluplně</h2>
...
<p>Když fungujete v hybridním režimu, některým členům týmu mohou chybět neformální místa jako kuchyňka k přátelské konverzaci. Ať už fungujete ve Slacku, Teamsech nebo jiné alternativě, vytvořte prostor, kde si spolu mohou kolegové jen tak poklábosit, sdílet memes, nebo probrat poslední epizodu oblíbeného seriálu.</p>
<p>Pokud jste nový tým jako my, mohly by vám k seznámení se pomoct neformální video hovory.</p>
<p>My máme každý pátek Couch Talks, kde proběhne rozhovor s jedním z nás a uzavřeme ho zábavným kvízem na témata, která toho člověka baví. Je to příjemný způsob, jak se poznat a zjistit, že pracujete se skvělými a zajímavými lidmi. Jestli máte rádi své kolegy totiž mimo jiné ovlivňuje i angažovanost v práci.</p>
<p>Couch Talk s Dušanem Murčem 🍕</p>
<h2>5) Nezapomeňte chválit</h2>
...
<p>Podle studie by až 66 % [1] lidí skončilo v práci, pokud by se cítili nedoceněni. U mladších generací pak toto číslo stoupá až na 76 %. Manažeři s přístupem cukr a bič mohou firmu stát majlant a vyplatí se přejít na people-first přístup.</p>
<h2>6) Nastolte work-life balance jako firemní hodnotu</h2>
<p>Největší výzvou práce v remote režimu je odpojení se od práce.</p>
<p>Když zaměstnanci dojíždí do kanceláře, tak cesta do práce a z práce je jakýmsi přechodovým rituálem mezi domácím a pracovním prostředím. Home office tento léta pěstovaný návyk odstranil a výsledkem jsou vyhořelí zaměstnanci (spolu s trendy jako</p>
<p>The Great Resignation nebo Quiet Quitting).</p>
<p>Během pandemie se ukázalo, že pouhé zaklapnutí notebooku v home office k vypnutí hlavy nestačí. Lidé často kontrolují e-maily a Slack na mobilu s tím, že “co kdyby náhodou” je někdo sháněl. Nepřetržitá dostupnost je však výsledkem nedostatečné komunikace očekávání. A pokud zprávy od šéfa chodí i v deset večer, pak zrovna nejde dobrým příkladem. Zdravý work-life balance přispívá k well-beingu zaměstnanců a spokojenost vede k větší angažovanosti.</p>
<h2>7) Dejte lidem šanci růst</h2>
<p>Zaměstnanci se přestávají angažovat, když se práce stane nudnou rutinou, která je</p>
<p>nenaplňuje a nemají se kam posouvat.</p>
<p>Na firemní vzdělávání je často pohlíženo jako na náklad místo investice. Bývá to jedna z prvních věcí, které se škrtají rozpočty. Tento krok se firmám vrací jako bumerang v podobě</p>
<p>nespokojených, neangažovaných zaměstnanců, a dokonce častých odchodů [2].</p>
...
`,
  ...
  /* ───────────────────────── 15 ───────────────────────── */
  {
    ...
    title_cz: 'Inspirativní TED Talky pro HR profesionály a leadery',
    slug: 'inspiring-ted-talks-for-hr-professionals',
    excerpt: 'Want to brighten up your day with a cup of inspiration? We have selected the best ideas worth spreading from speakers in the field of human resources and leadership. Get your pencil and notebook ready and open your mind, because the ideas will be pouring right in.',
    excerpt_cz: 'Chcete si zpestřit den šálkem inspirace? Vybrali jsme pro vás ty nejlepší myšlenky, které stojí za to šířit od řečníků z oblasti lidských zdrojů a leadershipu. Připravte si tužku se zápisníkem a otevřenou mysl, protože nápady se vám tam budou přímo sypat.',
    content: `
<h2>Rainer Strack: The workforce crisis of 2030—and how to start solving it now</h2>
<p class="lead">Did you know that by 2030, the countries of the most developed economies will have more jobs than people to do the work? HR expert Rainer Strack recommends focusing on a human resources strategy to help companies address the shortage of skilled workers. He sees solutions in four areas - forecasting the</p>
<p>competencies and positions needed, a plan for attracting great people, creating a system of internal training (upskilling and reskilling), and finally a plan for retaining great people. However, the first step to future success will be to change the leadership philosophy to a people-first approach: “Employees are a resource and an asset to the company, not mere costs, numbers, and machines.” – Rainer Strack</p>
<h2>Regina Hartley: Why the best hire might not have the perfect resume</h2>
<p>Imagine you put out an ad and two candidates apply. The first one has a top degree from a prestigious university, speaks several languages, and has the required experience. And then you get someone who has inconsistent work experience, only a high school diploma, but whose cover letter radiates with passion for the position. Which candidate has more potential to succeed? The answer may not be what you think. Regina Hartley has a great TED Talk about bias in recruiting. And we would just add that bias can be prevented by screening candidates with online assessments. The results will help you get a better idea of what competencies a person really has. Regardless of what they have listed on their CV.</p>
<p>“Choose an underrated candidate whose secret weapon is passion and ambition.” – Regina Hartley Simon Sinek: How great leaders inspire action What distinguishes exceptional leaders from average ones? Why do we naturally follow some of them and the others don&#x27;t inspire us to take action? Simon Sinek looked into this and found that there are two kinds of leaders–– those who are leaders and those who lead us.</p>
...
<p>“The most meaningful way to succeed is to help others succeed.” – Adam Grant Matt Mullenweg: Why working from home is good for business According to recent surveys, remote workers are 13% more productive than office commuters. Why? It&#x27;s due to their work environment, which they can customize to suit their needs. According to Mullenweg, employee autonomy is one of the competitive advantages for companies. In his TED Talk, he passed on plenty of great tips on what to look for if you want to succeed in remote mode too. “Talent and intelligence can be found in all people in the world. But not everyone has equal opportunity.” – Matt Mullenweg Which ideas from the TED talks resonated with you the most?</p>
<p>Join the discussion on LinkedIn and make us happy by sharing the article with your colleagues.</p>
`,
    content_cz: `
<p class="lead">Rainer Strack: Překvapující krize zaměstnanosti v roce 2030 – a jak ji začít řešit už teď Věděli jste, že v roce 2030 budou mít státy nejvyspělejších ekonomik více pracovních míst než lidí, kteří by tu práci mohli vykonávat? HR expert Rainer Strack doporučuje zaměřit se na strategii lidských zdrojů, která pomůže firmám nedostatek kvalifikovaných zaměstnanců vyřešit. Řešení vidí ve čtyřech oblastech – předpovídání potřebných</p>
<p>kompetencí a pozic, plán pro přilákání skvělých lidí, vytvoření systému interního vzdělávání (upskilling a reskilling), a nakonec i plán pro udržení si skvělých lidí. Avšak prvním krokem k úspěchu v budoucnosti bude změna filozofie vedení firmy na people-first přístup::</p>
<blockquote>„Zaměstnanci jsou zdrojem a přínosem pro firmu, nikoliv pouhé náklady, čísla a stroje.“ – Rainer Strack Regina Hartley: Proč ten nejlepší kandidát nemá perfektní životopis Představte si, že vypíšete inzerát a na něj se vám přihlásí dva kandidáti. Ten první má špičkové vzdělání z prestižní vysoké školy , mluví několika jazyky a má požadované zkušenosti. A pak se vám přihlásí někdo, kdo má nekonzistentní pracovní zkušenosti vzdělání pouze maturitu, ale z motivačního dopisu srší zapálení pro pozici. Který kandidát má větší potenciál uspět? Odpověď možná není taková, jak si myslíte. O předsudcích v náboru má skvělý TED Talk Regina Hartley. A my bychom k tomu jen dodali, že předsudkům lze předcházet i tak, že kandidáty prověříte online assessmenty. Výsledky vám pomohou získat lepší představu, jaké kompetence, předpoklady a pracovně-kulturní potřeby člověk skutečně má. Nehledě na to, co má uvedené v životopise. „Vyberte si podceňovaného uchazeče, jehož tajnou zbraní je vášeň a cílevědomost.“ – Regina Hartley Simon Sinek: Jak skvělí leadeři inspirují k akci Co odlišuje výjimečné leadery Proč některé z nich přirozeně následujeme a ti ostatní s námi ani nehnou? Simon Sinek se tomu podíval na zoubek, a zjistil, že jsou dva druhy leaderů – ti, kteří jsou vůdci a ti, kteří nás vedou. Vůdci vycházejí z pozice autority a moci. A ti, kteří nás vedou, nás inspirují svým PROČ. Následujeme je, protože chceme, ne protože musíme. Tento princip se pak dá krásně aplikovat nejen na vedení lidí, ale i na komunikaci k zákazníkům. „Lidé nekupují to, co děláte, ale kupují proč to děláte.“ – Simon Sinek Adam Grant: Jste dárce nebo příjemce? Podle Granta jsou v každé firmě najdete tři typy lidí: dárce, příjemce a dorovnávač. Do které skupiny patří ti nejúspěšnější a nejproduktivnější zaměstnanci? Odpověď vás možná překvapí. Ve svém TED Talku Adam Grant nabídl hned několik praktických tipů, jak vytvořit ideální prostředí pro tyto ideální zaměstnance a jak je ochránit (před sebou samotnými i před ostatními skupinami lidí). „Nejsmysluplnější způsob, jak uspět, je pomáhat druhým uspět.“ – Adam Grant Matt Mullenweg: Proč je práce z domova dobrá pro podnikání Podle posledních průzkumů jsou remote zaměstnanci o 13 % produktivnější než ti, co docházejí do kanceláře. Proč? Vliv na to má jejich pracovnímu prostředí , které si mohou přizpůsobit dle svých potřeb. Podle Mullenwega je autonomie zaměstnanců jedna z konkurenčních výhod pro firmy. Ve svém TED Talku předal plno skvělých tipů, na co se zaměřit pokud v remote režimu chcete uspět i vy. „Talent a inteligenci najdete u všech lidí ve světě. Ale ne všichni mají rovné příležitosti.“ – Matt Mullenweg</blockquote>
<p>Které myšlenky z TED talků s vámi rezonovaly nejvíce?</p>
<p>Zapojte se do diskuse na LinkedInu a uděláte nám radost, když článek budete sdílet se svými kolegy.</p>
`,
  ...
  /* ───────────────────────── 16 ───────────────────────── */
  {
    ...
    title_cz: '5 trendů, které změní jak pracujeme',
    slug: '5-trends-that-will-transform-the-way-we-work',
    excerpt: 'The world is literally changing before our eyes and with it the way we work. What are the trends in HR and leadership? Which skills will make you the most desirable employee? Let\'s take a peek into the near future together so you can stay one step ahead.',
    excerpt_cz: 'Svět se nám doslova mění před očima a s ním i způsob jakým budeme pracovat. Co nás čeká za trendy v HR a leadershipu? Které dovednosti z vás udělají nejžádanější zaměstnance? Pojďme spolu nahlédnout do blízké budoucnosti, ať můžete být krok napřed. Lenka Šilhánová září 27, 2022 - 4 minuty 1) Nábo...',
    content: `
<h2>1. Recruitment based on competencies instead of experience and education</h2>
<p class="lead">A CV will tell you about past experience, but you won&#x27;t know what potential a candidate really has. And that&#x27;s what</p>
<p>work competencies, which are the sum of the behaviors, knowledge, skills, abilities, attitudes, and values needed for the job, will reveal.</p>
<h2>Companies are beginning to</h2>
<p>modernize their recruitment process and online assessments are growing in popularity. They take away a lot of paperwork for HR professionals and managers, such as devising and assessing tasks for candidates. It makes the whole process more efficient, fair, and flexible. How can Behavera help you with this trend? Reach out to us at hello(at)behavera.com.</p>
<h2>2. Digital skills as the most in-demand abilities</h2>
<p>Using and mastering technology will be one of the most needed skills in the labor market in 2025 [1], the World Economic Forum said. All industries are going through a digital transformation, and virtually every company is becoming technological as a result [2]. Among other things, this will result in 50% [3] of employees having to requalify in the next few years.</p>
<p>The new trend in employability will no longer just be about soft skills such as communication, collaboration, critical thinking, and emotional intelligence. These will be joined by digital skills and the associated adaptability to rapid change.</p>
<h2>3. Remote work and international teams</h2>
<p>The pandemic has normalized remote work and kickstarted a boom in the development of digital tools, opening the door to an international labor market.</p>
<p>A global shortage of skilled workers has triggered a fight [4] between companies for the best of them. This has led the most resourceful workers to work for multiple employers at once, but often in secret [5].</p>
<p>According to recent research, young people change between 12-15 jobs in their working lives. In other words, talent will always go for the best offer, and often this will be abroad without having to emigrate from their home country. Technology allows people to work anytime, anywhere. For companies, this will have to mean adapting processes, from recruitment to actual operations. And for people, a change of mindset from a single occupation to career mobility and from specialization to transferable skills. But how individual countries will manage to adapt their labor codes is still a big question mark.</p>
...
<p>People-first leaders, however, understand the direct link between employee well-being and productivity. They are not looking for quick and one-off solutions, but are thinking long-term.</p>
...
`,
    content_cz: `
<h2>1) Nábor podle kompetencí místo praxe a vzdělání</h2>
<p class="lead">Životopis vám prozradí minulé zkušenosti, ale už nezjistíte jaký potenciál kandidát skutečně má. A právě to vám odhalí</p>
<p>pracovní kompetence, které jsou souhrnem chování, vědomostí, dovedností, schopností, postojů a hodnot potřebných pro zastávání dané pracovní pozice.</p>
<p>Firmy začínají modernizovat svůj náborový proces a online assessmenty rostou na popularitě. HR profesionálům a manažerům díky nim odpadá mnoho administrativy, jako například vymýšlení a vyhodnocování úkolů pro kandidáty. Celý proces se tak stává efektivnější, férovější a flexibilnější. Jak vám s tímto trendem může pomoci Behavera? Napište nám na hello(at)behavera.com.</p>
<h2>2) Digitální dovednosti jako nejžádanější dovednost</h2>
<p>Používání a ovládání technologií bude jednou z nejpotřebnějších dovedností na trhu práce v roce 2025 [1], uvedlo Světové ekonomické fórum. Všechna odvětví si procházejí digitální transformací a prakticky každá firma se tak stává technologickou [2]. To mimo jiné bude mít za následek, že 50 % [3] zaměstnanců se bude muset v nejbližších několika letech rekvalifikovat.</p>
<p>Nový trend v zaměstnatelnosti už nebude jen o soft skills, jako komunikace, schopnost spolupráce, kritické myšlení a emoční inteligence. K nim se přidávají právě digitální dovednosti a s nimi spojená adaptovatelnost na rychlé změny.</p>
...
<p>Celosvětový nedostatek kvalifikovaných pracovníků vyvolal boj [4] mezi firmami o ty nejlepší z nich. To vedlo ty vynalézavější pracovníky k práci pro více zaměstnavatelů naráz, často však v tajnosti [5].</p>
<p>Podle posledních výzkumů mladí lidé vystřídají 12-15 zaměstnání za svůj pracovní život. Jinými slovy, talent vždy půjde za nejlepší nabídkou a často to bude i do zahraničí bez nutnosti emigrace z rodné hroudy. Technologie umožňují lidem pracovat kdykoliv a odkudkoliv. Pro firmy to bude muset znamenat přizpůsobení procesů, od náboru až po samotné fungování. A pro lidi změnu mindsetu z jednoho povolání na kariérní mobilitu a ze specializace na přenositelné dovednosti. Jak to však celé zvládnou jednotlivé státy s adaptací zákoníků práce, to je zatím ve hvězdách.</p>
<h2>4) Práce místo zaměstnání</h2>
<p>Už dávno minuly časy, kdy člověk nastoupil do zaměstnání, kde zůstal 40 let než odešel do důchodu se zlatými hodinkami za věrnost. Dnes se v zaměstnání člověk ohřeje</p>
<p>průměrných 4.2 roku [6] a tato doba se bude s nástupem Generace Z na pracovní trh ještě více zkracovat.</p>
<p>Vliv na to však nebude mít jen touha po změně na straně zaměstnanců, ale rychle zastarávající dovednosti nebo samotná “nepotřebnost” dané pozice, například vlivem automatizace, digitalizace či umělé inteligence.</p>
<p>Jedním z trendů tak bude najímání pracovníků na výkon konkrétní práce [7] na projektu místo zaměstnání se striktně danou pracovní náplní. Zaměstnavatelé tedy budou potřebovat mít přehled o tom, jaké kompetence budou pro dané projekty potřebovat a kdo z jejich ověřené sítě pracovníků je má – případně jaké budou potřebovat na trhu najít a najmout.</p>
<h2>5) Well-being jako nutnost a ne jen benefit</h2>
<p>Inflace, válka na Ukrajině, pandemie, digitalizační smršť a celkové obavy z budoucnosti se</p>
<p>podepisují na mentálním zdraví nás všech Není divu, že právě teď se na sociálních sítích velmi skloňuje termín quiet quitting (tichá rezignace), kdy lidé hledají úlevu od přepracování a naopak firmy se obávají nízké produktivity.</p>
<p>People-first leadeři však chápou přímou souvislost mezi well-beingem a produktivitou zaměstnance. Nehledají rychlá a jednorázová řešení, ale přemýšlí dlouhodobě.</p>
...
<p>Co říkáte na těchto pět trendů v HR? Jsou to podle vás změny k lepšímu, které vyřeší některé současné výzvy? Nebo to jsou jen výdobytky, které zmizí tak rychle jak se jen objevily? Podělte se s námi o svou vizi budoucnosti na</p>
<p>LinkedInu a uděláte nám radost, když článek nasdílíte se svými kolegy.</p>
<h2>Zdroje:</h2>
...
`,
  ...
  /* ───────────────────────── 17 ───────────────────────── */
  {
    ...
    title_cz: 'Budoucnost úspěchu firem je v people-first přístupu',
    slug: 'the-future-of-work-is-in-the-people-first-approach',
    excerpt: 'Why do you have people quitting and quality candidates not applying? High turnover and lack of people troubles a lot of companies in the world[1]. However, the problem may not be in the benefits, but in the attitude of companies towards people. Long gone are the days when employees were mere huma...',
    excerpt_cz: 'Proč vám lidé odcházejí a kvalitní uchazeči se nehlásí? Velká fluktuace a nedostatek lidí trápí většinu firem v Česku[1]. Zakopaný pes však nemusí být v benefitech, ale v přístupu firem k lidem. Dávno pominula doba, kdy byli zaměstnanci pouhými lidskými zdroji. Leadeři úspěšných firem chápou, že ...',
    content: `
<p class="lead">What is the people-first approach?</p>
<p>The people-first approach brings humanity back to business. Employee satisfaction is as important as profit, and leaders treat their employees with respect, understanding, and fairness. They create an environment where teams are highly motivated, see deeper meaning in their work, and are more engaged. Naturally, this then translates to the company&#x27;s reputation and profitability.</p>
<blockquote>&quot;Take good care of your employees, and they&#x27;ll take good care of your customers, and the customers will come back.&quot; – J. W. Marriott, founder of Marriott company, a prime example of a successful people-first approach. The opposite of the people-first approach is the ruthless pursuit of profit and the priority of satisfying shareholders. A way of running companies that has become a trend, and later the norm [2] , since the publication of The Theory of the Firm . But we ask— isn&#x27;t it high time to leave this approach in the last century? Employees invest their time in companies and spend a substantial part of their lives at work. If time is money, why don&#x27;t we value our people as much as our investors? But changing the approach from profit-first to people-first shouldn&#x27;t start and end with creating catchy slogans on a careers page and smiling employee photos on Instagram. People-first is not another marketing buzzword. It&#x27;s a fundamental change in management philosophy that must first take place internally . People-first starts with leaders, whose actions should embody the company&#x27;s mission, vision, and values. Setting an example and inspiring the rest of the team to naturally follow. What made companies start thinking about changing their approach? The pandemic had shuffled their cards and triggered a mass wave of resignations in the US, UK, and Europe. &quot;Companies face a range of challenges, including geopolitical, and economic uncertainty, climate issues, social changes, and cyber threats. In this kind of environment, they’ll succeed only if their people are fully engaged, motivated, and eager to contribute,&quot; PwC stated in their Global Workforce Hopes and Fears 2022 report [3] . But one thing is universally true. Profit-first is not a sustainable long-term strategy and companies are beginning to realize this. And it will be these organizations that attract the best people. In Behavera, the people-first approach is no template or status, it&#x27;s a journey We are paving the way from creating processes to setting goals so we can grow together as a company and as a team. In a sustainable and meaningful way, where we are not dragged down by events and change, but set the pace and stay the course. &quot;We build everything around simple values that serve as a compass for our decisions and also force us to keep our feet on the ground. From the start, we want to make sure we don&#x27;t live in a bubble of a small team, but that our people-first value can grow with us,&quot; explained Igor Kubíček, CEO and co-founder of Behavera. Behavera is going through a challenging chapter right now. During 2022, we have grown from 3 co-founders to a team of 16 people. &quot; We were looking for certain types of people who have the passion, potential, and desire to help others succeed, in addition to relevant experience, and expertise,&quot; said Igor. We processed over 500 candidates and interviewed nearly 200 before we found the right people. Some we talked to for months and others we knew within five minutes we&#x27;d seal the deal. Our first team building has proved that we made the right choice, but only time and the first hurdles will tell if our people-first approach is limping somewhere. &quot;For me personally, it&#x27;s important how that approach manifests itself in difficult times. Igor and I have gone through our fair share of crises, gritted our teeth, and somehow got through it. The rest of the team hasn&#x27;t gone through tough times with us just yet,&quot; Dušan Švancara, CTO and co-founder of Behavera, revealed with sincerity. &quot;We expect conflict––it would be naive to think we can manage without it. People-first is when, after a difficult and frustrating week, we can sit down together for a beer, have a good laugh at ourselves, and still look forward to Monday at work,&quot; added Dušan. That&#x27;s why we started building a company culture at the team building. We used the Culture Design Canvas tool and gradually created our own Culture Deck. Even though we are still a relatively small team, we take culture seriously and believe that we need to build it from the very beginning. &quot;The prerequisite for creating the best environment for a people-centered culture is genuine interest. In the people themselves, in their work, and in their contribution to the team beyond their results, ” says Samuel Nvota, Head of Product at Behavera. So we started to explore what is important to each of us and step by step our company culture will emerge.</blockquote>
<p>We don&#x27;t want to preach a people-first approach as a one-size-fits-all solution to all company problems. Instead, we would like to open a discussion on how to build better companies and how to bring humanity back to work in an era of digital boom. We believe our society needs a change in approach to the workplace like new shoes. We may be in for a few uncomfortable blisters, but the pandemic has revealed that no one wants to walk in those worn-out shoes anymore. A people-first reputation helps you attract qualified candidates and retain the best employees People want to work where they feel good. Happy employees and good old-fashioned chatter work best to attract candidates. Whether you&#x27;re a good or bad employer, people will talk about you––in person or on social media, your reputation will precede you.</p>
...
`,
    content_cz: `
<p class="lead">Co je to people-first přístup?</p>
<p>People-first přístup vrací lidskost do byznysu.</p>
<p>Spokojenost zaměstnanců je stejně důležitá jako zisk a leadeři jednají se svými zaměstnanci s respektem, pochopením a férovostí. Vytvářejí tak prostředí, kde jsou týmy silně motivované, ve své práci vidí hlubší smysl a více se angažují. Přirozeně se to pak projeví i na reputaci a ziskovosti firmy.</p>
<blockquote>„Když se dobře postaráte o své zaměstnance, postarají se stejně dobře o vaše zákazníky a ti se budou rádi vracet,” prohlásil J. W. Marriott, zakladatel společnosti Marriott, která je ukázkovým příkladem úspěšného people-first přístupu. Protipólem people-first přístupu je bezhlavá honba za ziskem a prvořadé uspokojení akcionářů. Způsob vedení firem, který se stal trendem, a později normou [2] od publikace Teorie firmy . My se ale ptáme – není na čase tento přístup nechat v minulém století? Zaměstnanci do firem investují svůj čas a v práci tráví podstatnou část svého života. Když čas jsou peníze, proč si neceníme svých lidí stejně jako investorů? Změna přístupu z profit-first na people-first by však neměla začínat a končit u vytvoření chytlavých sloganů na kariérní stránce a usměvavých fotkách zaměstnanců na Instagramu. People-first není dalším marketingovým buzzwordem. Je to zásadní změna ve filozofii vedení firmy, která musí nejdřív proběhnout uvnitř. People-first začíná u leaderů, kteří by svým jednáním měli ztělesňovat misi, vizi a hodnoty firmy. Jít příkladem a být inspirací pro zbytek týmu, který je bude přirozeně následovat. Co přimělo firmy začít přemýšlet o změně přístupu? Pandemie jim zamíchala kartami a spustila masovou vlnu odchodů z práce v USA, Velké Británii i Evropě. „Firmy čelí řadě výzev, včetně geopolitické a ekonomické nejistoty, klimatických problémů, sociálních změn a kybernetických hrozeb. V takovém prostředí uspějí pouze tehdy, pokud budou jejich zaměstnanci plně zapojeni, motivováni a ochotni se podílet na řešení problémů,” uvedla společnost PwC ve své zprávě Global Workforce Hopes and Fears 2022 [3]. Jedno však platí univerzálně. Zisk na prvním místě není dlouhodobě udržitelná strategie a firmy si to začínají uvědomovat. A to budou organizace, které přitáhnou ty nejlepší lidi. V Behaveře people-first není šablona ani stav, je to cesta Prošlapáváme ji od tvorby procesů až po stanovování cílů, abychom mohli společně růst jako firma i tým. Udržitelně a smysluplně, kde nás události a změny nevláčí, ale sami určujeme jejich tempo a držíme kurz. „Vše stavíme kolem jednoduchých hodnot, které slouží jako kompas pro naše rozhodování a zároveň nás nutí být nohama na zemi. Od začátku chceme, abychom nežili v bublině malého týmu, ale aby naše people-first hodnota mohla růst s námi,” vysvětluje Igor Kubíček, CEO a spoluzakladatel Behavery. Behavera si právě prochází zatěžkávací zkouškou. Během roku 2022 jsme se rozrostli ze 3 spoluzakladatelů na tým 16 lidí. „Hledali jsme určité typy lidí, kteří kromě odpovídajících zkušeností a odbornosti mají i zápal, potenciál a touhu pomáhat druhým uspět,” dodal Igor. Zprocesovali jsme přes 500 kandidátů a udělali skoro 200 pohovorů než jsme našli ty správné lidi. S někým jsme se bavili měsíce a u někoho jsme během pěti minut věděli, že si plácneme. Že jsme si vybrali správně nám odhalil první teambuilding, avšak jen čas a první překážky ukáží, jestli nám náš people-first přístup někde nekulhá. „Pre mňa osobne je dôležité, ako sa ten prístup prejaví v ťažkých časoch. S Igorom sme si to už niekolkokrát vyskúšali, zatli zuby a nejako sa cez ně preniesli. Zvyšok tímu si to s nami nezažil,” s upřímností prozradil Dušan Švancara, spoluzakladatel Behavery. „Sme nastavení tak, že konflikty očakávame (bolo by naivné si myslieť, že to pôjde bez nich), akceptujeme a vyriešime. People-first je, keď si po ťažkom a &quot;uhádanom&quot; týždni, dokážeme spolu sadnúť na pivo, pobaviť sa sami nad sebou a těšiť sa na pondelok v práci,” dodal Dušan. Na teambuildingu jsme proto začali s budováním firemní kultury. Osvědčil se nám nástroj Culture Design Canvas a postupně si vytvoříme vlastní Culture Deck. I když je nás zatím relativně málo, kulturu bereme vážně a věříme, že je potřeba ji budovat od samého začátku. „Predpokladom vytvorenia najlepšieho prostredia pre kultúru zameranú na ľudí je skutočný záujem. V samotných ľuďoch, v ich práci a v ich prínose pre tím nad rámec ich výsledkov,” říká Samuel Nvota, Head of Product v Behaveře. A proto jsme začali zkoumat, co je důležité pro každého z nás a krůček po krůčku vznikne naše firemní kultura. O people-first přístupu nechceme kázat jako o samospásném řešení na všechny problémy firem. Místo toho bychom rádi otevřeli diskuzi na téma, jak budovat firmy lépe a jak vrátit do práce lidskost v době digitálního boomu. Věříme, že změnu přístupu naše společnost potřebuje jako nové boty. Možná nás čeká pár nepříjemných puchýřů, ale pandemie odhalila, že v těch prošmajdaných křuskách už nikdo dál chodit nechce. Reputace people-first firmy vám pomůže přilákat kvalifikované kandidáty a udržet ty nejlepší zaměstnance Lidé chtějí pracovat tam, kde se budou cítit dobře. Pro přilákání kandidátů nejlépe fungují spokojení zaměstnanci a stará dobrá šuškanda. Ať už jste dobrý nebo špatný zaměstnavatel, lidé si to řeknou. Osobně nebo na sociálních sítích, vaše pověst vás bude předcházet. Změna přístupu k people-first je dlouhodobá investice a budování reputace funguje jako složené úročení. Na začátku to jsou drobné, ale časem se to mnohonásobně vrátí. Jak? Stanete se vyhledávanou firmou , kde chtějí pracovat ti nejlepší. Nebudete potřebovat tak velký rozpočet na nábor. Protože u vás budou lidé spokojenější , nebudou tak často odcházet. Vysoká fluktuace se prodraží, ale to vás trápit nebude. Díky špičkovému talentu budete mít lepší produkty a služby. Zákazníci vás budou vyhledávat a sníží se náklady na marketing i prodej.</blockquote>
<p>Co říkáte na myšlenku people-first přístupu?</p>
<p>Pojďme se spojit na LinkedInu a uděláte nám radost, když se o článek podělíte se svými kolegy.</p>
<h2>Zdroje:</h2>
<p>[1] Behavera.com: Největší výzvy HR v roce 2022, náš výzkum [2] Forbes.com: The Power of Putting People First, autor Rasmus Hougaard [3] PwC.com:</p>
