...
<p>Karlovi a jeho týmu bylo jasné, že řešení problémů zaměstnanců a jejich pracovních podmínek se nedá dále odkládat a prioritizovali je stejně jako řešení problémů zákazníků nebo businessu jako takového.</p>
<h3>Se změnami nebylo na co čekat</h3>
<p>Vyzbrojeno těmito informacemi, vedení společnosti Valxon začalo rychle jednat. „Nebylo na co čekat. Měli jsme k dispozici jasná data, takže jsme vytvořili plán s cíli na 1. čtvrtletí a okamžitě začali se změnami," řekl Karel Poplstein, CEO.</p>
...
<p>Vedení také zavedlo nástroje pro zefektivnění procesů ke snížení zbytečné pracovní zátěže a automatizaci opakujících se úkolů. Pro další podporu týmů plánují vyhradit manažerům rozpočty dedikované na zlepšení pracovních podmínek, a tak jim poskytnout větší samostatnost a flexibilitu v rozhodování.</p>
<p><strong>Prioritou se stala transparentní komunikace</strong> – výsledky společnosti Behavera se otevřeně diskutují na all-hands prezentacích. Tento přístup ukázal zaměstnancům, že vedení aktivně využívá data k provádění smysluplných změn.</p>
...
<p>„Často sa opierame o frázu ‚work hard, play hard‘, ale práve táto doba si zaslúži pridať ‚rest well‘. Nájdite si udržateľný model medzi stress and rest, pretože aj vy chcete byť funkčná súčasť svojho teamu čo najdlhšie,“ doporučuje náš Dušan Murčo, který shrnul praktické tipy o vedení lidí na dálku ve svém Remote Leadership Manifesto . Práce a vedení lidí vyžaduje hodně energie. Dušan doporučuje, aby si leadeři vytvořili rutiny , které jim pomohou dobít baterky i během dne v práci. Ať už je to zavolání si s blízkými, dechové cvičení, zdravá svačinka, nebo cokoliv jiného, co vám vyhovuje.</p>
<p>Experimentujte a skrze to poznejte sami sebe. Dovolte si nejet na dřeň a nezapomínat na sebe. „Neodsúvajte to. Začnite a robte to pravidelne , dajte si to do kalendára a sústreďte sa na to,“ dodal. Kromě rutin a drobných návyků můžete začít pracovat na změně celkového přístupu k práci . Pokud je váš kalendář rychle zaplněn pracovními povinnostmi, tak nemáte prostor plánovat kvalitní čas s rodinou, sport či čas na hlubokou práci. Je potřeba zaujmout opačný postoj a nastavit hranice. <strong>Jako první v kalendáři prioritizuje volno pro rodinu a koníčky</strong>, vyblokujte si čas na sportovní aktivity a nakonec čas na nerušenou hlubokou práci.</p>
...
<p>conference-board.org</p>
<h2>HRD Collective North America</h2>
<p>Tahle konference slibuje, že se nejedná čistě o přednášky, ale o diskuze a panely, kde si seniorní HR profesionálové vyměňují zkušenosti. Loňský ročník přivítal hosty z firem jako je Microsoft, Twitter, New Balance, Firelli, L&#x27;Oreal, Boeing, Volvo, Citi, Warner Bros a další. Věříme, že i letos nás čeká nadupaný seznam hostů.</p>
...
<p>Přehled rizikových faktorů. Praktická doporučení od behaviorálních psychologů.</p>
<h3>Jak začít s Well-being Indexem?</h3>
...
`,
    content_cz: `
<p class="lead">Well-beingu lze dosáhnout, když jsme <em>celkově spokojení se svým životem po osobní i profesní stránce</em>. Je to stav, který je neustále proměnný a můžeme ho ovlivnit pomocí naučitelných dovedností, podobně jako třeba pracujeme na svých měkkých dovednostech.</p>
...
<p><strong>Upřímně se zajímejte o názory a podněty svých zaměstnanců</strong>, ať už budou příjemné nebo nikoliv. Jedním ze zásadních způsobů, jak ovlivnit angažovanost, je vytvoření prostředí, kde si vzájemně nasloucháte a kde podle zpětné vazby vylepšujete vše, co váš tým trápí. Když lidé vidí, že na jejich názorech záleží a mají šanci něco ovlivnit, budou se přirozeně zapojovat do dění, protože to pro ně bude mít smysl.</p>
...
<p class="lead"><strong>Věděli jste</strong>, že v roce 2030 budou mít státy nejvyspělejších ekonomik více pracovních míst než lidí, kteří by tu práci mohli vykonávat? HR expert Rainer Strack doporučuje zaměřit se na strategii lidských zdrojů, která pomůže firmám nedostatek kvalifikovaných zaměstnanců vyřešit.</p>
<p>Řešení vidí ve čtyřech oblastech – předpovídání potřebných <strong>kompetencí a pozic</strong>, plán pro přilákání skvělých lidí, vytvoření systému interního vzdělávání (upskilling a reskilling), a nakonec i plán pro udržení si skvělých lidí. Avšak prvním krokem k úspěchu v budoucnosti bude změna filozofie vedení firmy na people-first přístup:</p>
...
<p>Už dávno minuly časy, kdy člověk nastoupil do zaměstnání, kde zůstal 40 let než odešel do důchodu se zlatými hodinkami za věrnost. Dnes se v zaměstnání člověk ohřeje <strong>průměrných 4,2 roku</strong> [6] a tato doba se bude s nástupem Generace Z na pracovní trh ještě více zkracovat.</p>
...
<p>Behavera si právě prochází zatěžkávací zkouškou. Během roku 2022 jsme se rozrostli ze 3 spoluzakladatelů na tým 16 lidí. „Hledali jsme určité typy lidí, kteří kromě odpovídajících zkušeností a odbornosti mají i zápal, potenciál a touhu pomáhat druhým uspět,” dodal Igor.</p>
<p><strong>Zprocesovali jsme přes 500 kandidátů a udělali skoro 200 pohovorů</strong>, než jsme našli ty správné lidi.</p>
...
<p>Věříme, že změnu přístupu naše společnost potřebuje jako nové boty. Možná nás čeká pár nepříjemných puchýřů, ale pandemie odhalila, že v těch prošmajdaných křuskách už nikdo dál chodit nechce.</p>
