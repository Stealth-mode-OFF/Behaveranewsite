...
const DEFAULT_CASE_STUDIES: CaseStudy[] = [
  {
    ...
    content: `
      ...
      <p>Za pouhé tři minuty času každého zaměstnance získali v Průša Research data, která jim umožňují dlouhodobě posilovat svou reputaci atraktivního zaměstnavatele a přitahovat správné talenty na základě reálných zkušeností lidí uvnitř firmy.</p>
    `,
    content_cz: `
      <h2>Cíl</h2>
      <p>Cílem první fáze spolupráce s Behaverou bylo získat strukturovanou a otevřenou zpětnou vazbu od zaměstnanců a ověřit, jaký přínos může mít systematický sběr dat pro další rozvoj employer brandu. Zároveň chtělo vedení posoudit, jak může tento přístup zapadnout do jejich dlouhodobé HR a komunikační strategie.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Streamlined Feedback Process</h3>
    ...
    content_cz: `
      ...
      <h3>Zrychlený proces zpětné vazby</h3>
  ...
  },
  {
    ...
    content_cz: `
      ...
      <h3>Poznatky založené na datech</h3>
  ...
  },
  {
    ...
    content_cz: `
      ...
      <h3>Jasné poznatky o zaměstnancích</h3>
